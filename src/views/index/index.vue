<template>
  <div class="index-container">
    <el-row :gutter="15">
      ...
      >
        <el-alert
          title="作者初衷：iView Pro要卖￥9999，layui Admin要卖￥2600，市面上99%的免费框架都抄袭了花裤衩的开源项目，没有一点创新，作者只好自己动手写一个分享给大家咯，能不能一个框架同时支持做后端管理系统又能同时支持做常规对外展示的网页，于是横纵布局切换诞生了，免费的东西一定就差吗，一个人就一定比不过一个团队吗？我还那么年轻，我不会认输，在屏幕前驻足的你也不会轻易认输，对吧！弱小的人才习惯嘲讽与否定，内心强大的人从不吝啬赞美与鼓励，人生在世，得到每个人的认可几乎是痴心妄想，我也只是一条略懂前端的咸鱼，可我仍一直怀揣着改变世界的梦想，希望我们每个人，不管过程怎样，结局都是美好的。。。"
          :closable="false"
        >
          <a
            target="_blank"
