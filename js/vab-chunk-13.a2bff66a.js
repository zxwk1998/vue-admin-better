...
23648: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  META_DATA_PREFIX: function() { return META_DATA_PREFIX; },
  SVGNS: function() { return SVGNS; },
  XLINKNS: function() { return XLINKNS; },
  XMLNS: function() { return XMLNS; },
  XML_NAMESPACE: function() { return XML_NAMESPACE; },
  createBrushScope: function() { return createBrushScope; },
  createElement: function() { return createElement; },
  createSVGVNode: function() { return createSVGVNode; },
  createVNode: function() { return createVNode; },
  getCssString: function() { return getCssString; },
  vNodeToString: function() { return vNodeToString; }
});
/* ESM import */var _core_util_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39238);
/* ESM import */var _core_dom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(65474);
...
function vNodeToString(el, opts) {
    ...
    function convertElToString(el) {
        ...
        return createElementOpen(tag, attrs)
            + (tag !== 'style' ? (0,_core_dom_js__WEBPACK_IMPORTED_MODULE_0__.encodeHTML)(text) : text || '')
            + (children ? "" + S + (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.map)(children, function (child) { return convertElToString(child); }).join(S) + S : '')
...
15686: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  setPattern: function() { return /* binding */ setPattern; },
  setClipPath: function() { return /* binding */ setClipPath; },
  brush: function() { return /* binding */ brush; },
  brushSVGPath: function() { return /* binding */ brushSVGPath; },
  brushSVGTSpan: function() { return /* binding */ brushSVGTSpan; },
  setGradient: function() { return /* binding */ setGradient; },
  brushSVGImage: function() { return /* binding */ brushSVGImage; }
});
...
var graphic_Image = __webpack_require__(65632);
...
var TSpan = __webpack_require__(21569);
...
var dashStyle = __webpack_require__(734);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/zrender@6.0.0/node_modules/zrender/lib/svg/core.js
var core = __webpack_require__(23648);
// EXTERNAL MODULE: ./node_modules/.pnpm/zrender@6.0.0/node_modules/zrender/lib/graphic/helper/image.js
var helper_image = __webpack_require__(6059);
...
function createCompoundPathCSSAnimation(el, attrs, scope) {
    ...
    (0,util.each)(paths, function (path) {
        var subScope = (0,core.createBrushScope)(scope.zrId);
...
function setMetaData(attrs, el) {
    ...
    if (metaData) {
        metaData.each(function (val, key) {
            val != null && (attrs[(core.META_DATA_PREFIX + key).toLowerCase()] = val + '');
        });
        if (el.isSilent()) {
            attrs[core.META_DATA_PREFIX + 'silent'] = 'true';
        }
    }
}
...
function brushSVGPath(el, scope) {
    ...
    return (0,core.createVNode)(svgElType, el.id + '', attrs);
}
function brushSVGImage(el, scope) {
    ...
    setMetaData(attrs, el);
    scope.animation && createCSSAnimation(el, attrs, scope);
    return (0,core.createVNode)('image', el.id + '', attrs);
}
;
function brushSVGTSpan(el, scope) {
    ...
    setMetaData(attrs, el);
    scope.animation && createCSSAnimation(el, attrs, scope);
    return (0,core.createVNode)('text', el.id + '', attrs, undefined, text);
}
...
function setShadow(el, attrs, scope) {
    ...
    if ((0,helper.hasShadow)(style)) {
        ...
        if (!shadowId) {
            ...
            scope.defs[shadowId] = (0,core.createVNode)('filter', shadowId, {
                'id': shadowId,
                'x': '-100%',
                'y': '-100%',
                'width': '300%',
                ...
                (0,core.createVNode)('feDropShadow', '', {
                    'dx': offsetX / scaleX,
                    'dy': offsetY / scaleY,
...
function setGradient(style, attrs, target, scope) {
    ...
    for (var i = 0, len = colors.length; i < len; ++i) {
        ...
        colorStops.push((0,core.createVNode)('stop', i + '', stopsAttrs));
    }
    var gradientVNode = (0,core.createVNode)(gradientTag, '', gradientAttrs, colorStops);
    var gradientKey = (0,core.vNodeToString)(gradientVNode);
    ...
    if (!gradientId) {
        ...
        scope.defs[gradientId] = (0,core.createVNode)(gradientTag, gradientId, gradientAttrs, colorStops);
    }
...
function setPattern(el, attrs, target, scope) {
    ...
    if ((0,helper.isImagePattern)(val)) {
        ...
        child = (0,core.createVNode)('image', 'img', {
            href: imageSrc,
            width: imageWidth_1,
    ...
    var patternVNode = (0,core.createVNode)('pattern', '', patternAttrs, [child]);
    var patternKey = (0,core.vNodeToString)(patternVNode);
    ...
    if (!patternId) {
        ...
        patternVNode = scope.defs[patternId] = (0,core.createVNode)('pattern', patternId, patternAttrs, [child]);
    }
...
function setClipPath(clipPath, attrs, scope) {
    ...
    if (!clipPathId) {
        ...
        defs[clipPathId] = (0,core.createVNode)('clipPath', clipPathId, clipPathAttrs, [brushSVGPath(clipPath, scope)]);
    }
...
47843: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* ESM import */var _core_util_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39238);
/* ESM import */var _tool_color_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9894);
/* ESM import */var _core_env_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36287);
...
11345: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  updateAttrs: function() { return /* binding */ updateAttrs; },
  "default": function() { return /* binding */ patch; }
});
...
var colonChar = 58;
var xChar = 120;
var emptyNode = (0,core.createVNode)('', '');
function isUndef(s) {
    return s === undefined;
}
function isDef(s) {
...
function createElm(vnode) {
    ...
    var tag = vnode.tag;
    if (isDef(tag)) {
        var elm = (vnode.elm = (0,core.createElement)(tag));
        ...
        if (old !== cur) {
            if (cur === true) {
                ...
                if (key === 'style') {
                    ...
                    elm.setAttributeNS(core.XMLNS, key, cur);
                }
                else if (key.charCodeAt(3) === colonChar) {
                    elm.setAttributeNS(core.XML_NAMESPACE, key, cur);
                }
                else if (key.charCodeAt(5) === colonChar) {
                    elm.setAttributeNS(core.XLINKNS, key, cur);
                }
                else {
                    elm.setAttribute(key, cur);
                }
...
9894: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
56127: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var tool_path = __webpack_require__(2510);
// EXTERNAL MODULE: ./node_modules/.pnpm/zrender@6.0.0/node_modules/zrender/lib/core/Transformable.js
var Transformable = __webpack_require__(67928);
...
46130: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* ESM import */var _graphic_Group_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1170);
/* ESM import */var _graphic_Image_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(65632);
/* ESM import */var _graphic_shape_Circle_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8215);
/* ESM import */var _graphic_shape_Rect_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(44331);
/* ESM import */var _graphic_shape_Ellipse_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(60517);
/* ESM import */var _graphic_shape_Line_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(65449);
/* ESM import */var _graphic_shape_Polygon_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(40365);
/* ESM import */var _graphic_shape_Polyline_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8775);
/* ESM import */var _core_matrix_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(72935);
/* ESM import */var _path_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(2510);
/* ESM import */var _core_util_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39238);
/* ESM import */var _graphic_LinearGradient_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(33112);
/* ESM import */var _graphic_RadialGradient_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(54966);
/* ESM import */var _graphic_TSpan_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21569);
/* ESM import */var _parseXML_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(84665);
/* ESM import */var _color_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(9894);
...
84665: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
2510: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
55024: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* ESM import */var _core_env_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36287);
/* ESM import */var _core_util_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(39238);
/* ESM import */var _Handler_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(99548);
/* ESM import */var _Storage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(38611);
/* ESM import */var _animation_Animation_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(63025);
/* ESM import */var _dom_HandlerProxy_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(86341);
/* ESM import */var _tool_color_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9894);
/* ESM import */var _config_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(96702);
/* ESM import */var _graphic_Group_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1170);
/*!
