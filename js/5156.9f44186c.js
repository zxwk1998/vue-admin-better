 ...
 */
(self["webpackChunkvue_admin_better"] = self["webpackChunkvue_admin_better"] || []).push([["5156"], {
76200: (function (module, __unused_rspack_exports, __webpack_require__) {
var map = {
  "./colorfulIcon.js": "73323",
  "./goodsList.js": "49836",
  "./icon.js": "91489",
  "./menuManagement.js": "48664",
  "./personalCenter.js": "99869",
  "./roleManagement.js": "74239",
  "./router.js": "58253",
  "./table.js": "34946",
  "./tree.js": "50360",
  "./user.js": "94987",
  "./userManagement.js": "96300"
};
...
__rspack_context.id = 76200;


}),
73323: (function (module, __unused_rspack_exports, __webpack_require__) {
__webpack_require__(17932);
__webpack_require__(86204);
...
91489: (function (module, __unused_rspack_exports, __webpack_require__) {
__webpack_require__(17932);
__webpack_require__(86204);
...
99869: (function (module, __unused_rspack_exports, __webpack_require__) {
const {
  mock
} = __webpack_require__(6530);
module.exports = [{
...
74239: (function (module, __unused_rspack_exports, __webpack_require__) {
__webpack_require__(17932);
__webpack_require__(86204);
const totalCount = 2;
const List = [{
...
34946: (function (module, __unused_rspack_exports, __webpack_require__) {
__webpack_require__(52093);
__webpack_require__(17932);
__webpack_require__(86204);
const {
...
96300: (function (module, __unused_rspack_exports, __webpack_require__) {
__webpack_require__(17932);
__webpack_require__(86204);
const totalCount = 3;
const List = [{
...
76259: (function (module, __unused_rspack_exports, __webpack_require__) {
__webpack_require__(52093);
__webpack_require__(17932);
__webpack_require__(19329);
const {
  Random
} = __webpack_require__(6530);
const {
  join
} = __webpack_require__(52101);
const fs = __webpack_require__(15134);
...
22289: (function (__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
...
/* import */ var core_js_modules_es_json_stringify_js__rspack_import_4 = __webpack_require__(64189);
...
/* import */ var core_js_modules_esnext_json_parse_js__rspack_import_5 = __webpack_require__(33384);
/* import */ var core_js_modules_esnext_json_parse_js__rspack_import_5_default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_json_parse_js__rspack_import_5);
...
35007: (function (__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var core_js_modules_es_iterator_constructor_js__rspack_import_1 = __webpack_require__(17932);
/* import */ var core_js_modules_es_iterator_constructor_js__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_iterator_constructor_js__rspack_import_1);
/* import */ var core_js_modules_es_iterator_for_each_js__rspack_import_2 = __webpack_require__(19329);
/* import */ var core_js_modules_es_iterator_for_each_js__rspack_import_2_default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_iterator_for_each_js__rspack_import_2);
/* import */ var core_js_modules_esnext_json_parse_js__rspack_import_3 = __webpack_require__(33384);
/* import */ var core_js_modules_esnext_json_parse_js__rspack_import_3_default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_json_parse_js__rspack_import_3);
/* import */ var mockjs__rspack_import_4 = __webpack_require__(6530);
/* import */ var mockjs__rspack_import_4_default = /*#__PURE__*/__webpack_require__.n(mockjs__rspack_import_4);
/* import */ var _utils__rspack_import_5 = __webpack_require__(22289);
...
const files = __webpack_require__(76200);
files.keys().forEach(key => {
  mocks.push(...files(key));
});
function mockXHR() {
  // 设置Mock响应延迟
  mockjs__rspack_import_4_default().setup({
    timeout: '200-600'
  });

  // 保存原始的XHR send方法
  (mockjs__rspack_import_4_default().XHR.prototype.proxy_send) = (mockjs__rspack_import_4_default().XHR.prototype.send);
  (mockjs__rspack_import_4_default().XHR.prototype.send) = function () {
    if (this.custom.xhr) {
  ...
  function XHRHttpRequst(respond) {
    return function (options) {
      ...
      try {
        if (respond instanceof Function) {
          ...
          result = respond({
            method: type,
            body: parsedBody,
            query: (0,_utils__rspack_import_5.paramObj)(url)
          });
        } else {
          result = respond;
        }
      ...
      return mockjs__rspack_import_4_default().mock(result);
    };
  }

  // 注册所有的mock服务
  mocks.forEach(item => {
    mockjs__rspack_import_4_default().mock(new RegExp(item.url), item.type || 'get', XHRHttpRequst(item.response));
  });
