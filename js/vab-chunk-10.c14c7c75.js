 ...
 */
"use strict";
(self["webpackChunkvue_admin_better"] = self["webpackChunkvue_admin_better"] || []).push([["9505"], {
59480: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* import */ var _Source_js__rspack_import_2 = __webpack_require__(24126);
...
var SeriesDataSchema = /** @class */function () {
  ...
  SeriesDataSchema.prototype.getSourceDimensionIndex = function (dimName) {
    return (0,zrender_lib_core_util_js__rspack_import_1.retrieve2)(this._dimNameMap.get(dimName), -1);
  };
  /**
   * @caution Can only be used when `dimensionOmitted: true`.
   *
  ...
  SeriesDataSchema.prototype.makeStoreSchema = function () {
    ...
    var willRetrieveDataByName = (0,_Source_js__rspack_import_2.shouldRetrieveDataByName)(this.source);
...
function createDimNameMap(dimsDef) {
  var dataDimNameMap = (0,zrender_lib_core_util_js__rspack_import_1.createHashMap)();
  for (var i = 0; i < (dimsDef || []).length; i++) {
    var dimDefItemRaw = dimsDef[i];
    var userDimName = (0,zrender_lib_core_util_js__rspack_import_1.isObject)(dimDefItemRaw) ? dimDefItemRaw.name : dimDefItemRaw;
...
24079: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  createDimensions: function() { return createDimensions; },
  "default": function() { return prepareSeriesDataSchema; }
});
/* import */ var _util_types_js__rspack_import_6 = __webpack_require__(79390);
/* import */ var _SeriesDimensionDefine_js__rspack_import_4 = __webpack_require__(74703);
/* import */ var zrender_lib_core_util_js__rspack_import_1 = __webpack_require__(9774);
/* import */ var _Source_js__rspack_import_0 = __webpack_require__(24126);
/* import */ var _DataStore_js__rspack_import_3 = __webpack_require__(5746);
/* import */ var _util_model_js__rspack_import_5 = __webpack_require__(67698);
/* import */ var _sourceHelper_js__rspack_import_7 = __webpack_require__(44055);
/* import */ var _SeriesDataSchema_js__rspack_import_2 = __webpack_require__(59480);
...
source, opt) {
  if (!(0,_Source_js__rspack_import_0.isSourceInstance)(source)) {
    source = (0,_Source_js__rspack_import_0.createSourceFromSeriesDataOption)(source);
  }
  opt = opt || {};
  var sysDims = opt.coordDimensions || [];
  var dimsDef = opt.dimensionsDefine || source.dimensionsDefine || [];
  var coordDimNameMap = (0,zrender_lib_core_util_js__rspack_import_1.createHashMap)();
  var resultList = [];
  var dimCount = getDimCount(source, sysDims, dimsDef, opt.dimensionsCount);
  // Try to ignore unused dimensions if sharing a high dimension datastore
  // 30 is an experience value.
  var omitUnusedDimensions = opt.canOmitUnusedDimensions && (0,_SeriesDataSchema_js__rspack_import_2.shouldOmitUnusedDimensions)(dimCount);
  var isUsingSourceDimensionsDef = dimsDef === source.dimensionsDefine;
  var dataDimNameMap = isUsingSourceDimensionsDef ? (0,_SeriesDataSchema_js__rspack_import_2.ensureSourceDimNameMap)(source) : (0,_SeriesDataSchema_js__rspack_import_2.createDimNameMap)(dimsDef);
  var encodeDef = opt.encodeDefine;
  if (!encodeDef && opt.encodeDefaulter) {
    encodeDef = opt.encodeDefaulter(source, dimCount);
  }
  var encodeDefMap = (0,zrender_lib_core_util_js__rspack_import_1.createHashMap)(encodeDef);
  var indicesMap = new _DataStore_js__rspack_import_3.CtorInt32Array(dimCount);
  ...
  function getResultItem(dimIdx) {
    ...
    if (idx < 0) {
      ...
      var dimDefItem = (0,zrender_lib_core_util_js__rspack_import_1.isObject)(dimDefItemRaw) ? dimDefItemRaw : {
        name: dimDefItemRaw
      };
      var resultItem = new _SeriesDimensionDefine_js__rspack_import_4["default"]();
  ...
  encodeDefMap.each(function (dataDimsRaw, coordDim) {
    var dataDims = (0,_util_model_js__rspack_import_5.normalizeToArray)(dataDimsRaw).slice();
    // Note: It is allowed that `dataDims.length` is `0`, e.g., options is
    // `{encode: {x: -1, y: 1}}`. Should not filter anything in
    // this case.
    if (dataDims.length === 1 && !(0,zrender_lib_core_util_js__rspack_import_1.isString)(dataDims[0]) && dataDims[0] < 0) {
      encodeDefMap.set(coordDim, false);
      return;
    }
    var validDataDims = encodeDefMap.set(coordDim, []);
    (0,zrender_lib_core_util_js__rspack_import_1.each)(dataDims, function (resultDimIdxOrName, idx) {
      // The input resultDimIdx can be dim name or index.
      var resultDimIdx = (0,zrender_lib_core_util_js__rspack_import_1.isString)(resultDimIdxOrName) ? dataDimNameMap.get(resultDimIdxOrName) : resultDimIdxOrName;
  ...
  var availDimIdx = 0;
  (0,zrender_lib_core_util_js__rspack_import_1.each)(sysDims, function (sysDimItemRaw) {
    var coordDim;
    var sysDimItemDimsDef;
    var sysDimItemOtherDims;
    var sysDimItem;
    if ((0,zrender_lib_core_util_js__rspack_import_1.isString)(sysDimItemRaw)) {
      ...
      sysDimItem = (0,zrender_lib_core_util_js__rspack_import_1.extend)({}, sysDimItem);
    ...
    dataDims = (0,_util_model_js__rspack_import_5.normalizeToArray)(dataDims);
    ...
    // Apply templates.
    (0,zrender_lib_core_util_js__rspack_import_1.each)(dataDims, function (resultDimIdx, coordDimIndex) {
      var resultItem = getResultItem(resultDimIdx);
      // Coordinate system has a higher priority on dim type than source.
      if (isUsingSourceDimensionsDef && sysDimItem.type != null) {
        resultItem.type = sysDimItem.type;
      }
      applyDim((0,zrender_lib_core_util_js__rspack_import_1.defaults)(resultItem, sysDimItem), coordDim, coordDimIndex);
      if (resultItem.name == null && sysDimItemDimsDef) {
        var sysDimItemDimsDefItem = sysDimItemDimsDef[coordDimIndex];
        !(0,zrender_lib_core_util_js__rspack_import_1.isObject)(sysDimItemDimsDefItem) && (sysDimItemDimsDefItem = {
      ...
      sysDimItemOtherDims && (0,zrender_lib_core_util_js__rspack_import_1.defaults)(resultItem.otherDims, sysDimItemOtherDims);
    });
  });
  function applyDim(resultItem, coordDim, coordDimIndex) {
    if (_util_types_js__rspack_import_6.VISUAL_DIMENSIONS.get(coordDim) != null) {
  ...
  if (!omitUnusedDimensions) {
    for (var resultDimIdx = 0; resultDimIdx < dimCount; resultDimIdx++) {
      ...
      if (resultItem.type == null && ((0,_sourceHelper_js__rspack_import_7.guessOrdinal)(source, resultDimIdx) === _sourceHelper_js__rspack_import_7.BE_ORDINAL.Must
      // Consider the case:
      // {
      //    dataset: {source: [
      //        ['2001', 123],
    ...
    (0,zrender_lib_core_util_js__rspack_import_1.each)(resultList, function (resultItem) {
  ...
  return new _SeriesDataSchema_js__rspack_import_2.SeriesDataSchema({
    source: source,
...
function removeDuplication(result) {
  var duplicationMap = (0,zrender_lib_core_util_js__rspack_import_1.createHashMap)();
...
function getDimCount(source, sysDims, dimsDef, optDimCount) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_1.each)(sysDims, function (sysDimItem) {
    var sysDimItemDimsDef;
    if ((0,zrender_lib_core_util_js__rspack_import_1.isObject)(sysDimItem) && (sysDimItemDimsDef = sysDimItem.dimsDef)) {
...
10403: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _Source_js__rspack_import_0 = __webpack_require__(24126);
/* import */ var _util_types_js__rspack_import_1 = __webpack_require__(79390);
/* import */ var _util_log_js__rspack_import_3 = __webpack_require__(54137);
...
var DefaultDataProvider = /** @class */function () {
  function DefaultDataProvider(sourceParam, dimSize) {
    // let source: Source;
    var source = !(0,_Source_js__rspack_import_0.isSourceInstance)(sourceParam) ? (0,_Source_js__rspack_import_0.createSourceFromSeriesDataOption)(sourceParam) : sourceParam;
    ...
    if (sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_TYPED_ARRAY) {
      if (false) {}
      this._offset = 0;
  ...
  DefaultDataProvider.internalField = function () {
    ...
    mountMethods = function (provider, data, source) {
      ...
      if (false) {}
      (0,zrender_lib_core_util_js__rspack_import_2.extend)(provider, methods);
      if (sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_TYPED_ARRAY) {
        ...
        provider.getItem = (0,zrender_lib_core_util_js__rspack_import_2.bind)(rawItemGetter, null, data, startIndex, dimsDef);
        var rawCounter = getRawSourceDataCounter(sourceFormat, seriesLayoutBy);
        provider.count = (0,zrender_lib_core_util_js__rspack_import_2.bind)(rawCounter, null, data, startIndex, dimsDef);
      }
    };
    ...
    providerMethods = (_a = {}, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN] = {
      pure: true,
      appendData: appendDataSimply
    }, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_ROW] = {
      pure: true,
      appendData: function () {
        throw new Error('Do not support appendData when set seriesLayoutBy: "row".');
      }
    }, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS] = {
      pure: true,
      appendData: appendDataSimply
    }, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_KEYED_COLUMNS] = {
      pure: true,
      appendData: function (newData) {
        var data = this._data;
        (0,zrender_lib_core_util_js__rspack_import_2.each)(newData, function (newCol, key) {
    ...
    }, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL] = {
      appendData: appendDataSimply
    }, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_TYPED_ARRAY] = {
      persistent: false,
      pure: true,
      appendData: function (newData) {
        if (false) {}
...
var validateSimply = function (rawData) {
  if (!(0,zrender_lib_core_util_js__rspack_import_2.isArray)(rawData)) {
    (0,_util_log_js__rspack_import_3.error)('series.data or dataset.source must be an array.');
  }
};
/**
 * Only run in dev mode - hint users for debug.
 */
var rawSourceDataValidatorMap = (_a = {}, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN] = validateSimply, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_ROW] = validateSimply, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS] = validateSimply, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_KEYED_COLUMNS] = function (rawData, dimsDef) {
  for (var i = 0; i < dimsDef.length; i++) {
    var dimName = dimsDef[i].name;
    if (dimName == null) {
      (0,_util_log_js__rspack_import_3.error)('dimension name must not be null/undefined.');
    }
  }
}, _a[_util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL] = validateSimply, _a);
var getItemSimply = function (rawData, startIndex, dimsDef, idx) {
  return rawData[idx];
};
var rawSourceItemGetterMap = (_b = {}, _b[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN] = function (rawData, startIndex, dimsDef, idx) {
  return rawData[idx + startIndex];
}, _b[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_ROW] = function (rawData, startIndex, dimsDef, idx, out) {
  idx += startIndex;
  var item = out || [];
  var data = rawData;
  ...
  return item;
}, _b[_util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS] = getItemSimply, _b[_util_types_js__rspack_import_1.SOURCE_FORMAT_KEYED_COLUMNS] = function (rawData, startIndex, dimsDef, idx, out) {
  var item = out || [];
  for (var i = 0; i < dimsDef.length; i++) {
    var dimName = dimsDef[i].name;
  ...
  return item;
}, _b[_util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL] = getItemSimply, _b);
...
var rawSourceDataCounterMap = (_c = {}, _c[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN] = function (rawData, startIndex, dimsDef) {
  return Math.max(0, rawData.length - startIndex);
}, _c[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS + '_' + _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_ROW] = function (rawData, startIndex, dimsDef) {
  var row = rawData[0];
  return row ? Math.max(0, row.length - startIndex) : 0;
}, _c[_util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS] = countSimply, _c[_util_types_js__rspack_import_1.SOURCE_FORMAT_KEYED_COLUMNS] = function (rawData, startIndex, dimsDef) {
  var dimName = dimsDef[0].name;
  var col = dimName != null ? rawData[dimName] : null;
  return col ? col.length : 0;
}, _c[_util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL] = countSimply, _c);
...
var rawSourceValueGetterMap = (_d = {}, _d[_util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS] = getRawValueSimply, _d[_util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS] = function (dataItem, dimIndex, property) {
  return dataItem[property];
}, _d[_util_types_js__rspack_import_1.SOURCE_FORMAT_KEYED_COLUMNS] = getRawValueSimply, _d[_util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL] = function (dataItem, dimIndex, property) {
  // FIXME: In some case (markpoint in geo (geo-map.html)),
  // dataItem is {coord: [...]}
  var value = (0,_util_model_js__rspack_import_4.getDataItemValue)(dataItem);
  return !(value instanceof Array) ? value : value[dimIndex];
}, _d[_util_types_js__rspack_import_1.SOURCE_FORMAT_TYPED_ARRAY] = getRawValueSimply, _d);
...
function getMethodMapKey(sourceFormat, seriesLayoutBy) {
  return sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS ? sourceFormat + '_' + seriesLayoutBy : sourceFormat;
}
...
dim) {
  ...
  if (dim != null) {
    ...
    var result = dataItem;
    if (sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL) {
      result = (0,_util_model_js__rspack_import_4.getDataItemValue)(dataItem);
    }
    return result;
  }
}
...
function retrieveRawAttr(data, dataIndex, attr) {
  ...
  if (sourceFormat !== _util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL && sourceFormat !== _util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS) {
    return;
  }
  var dataItem = data.getRawDataItem(dataIndex);
  if (sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL && !(0,zrender_lib_core_util_js__rspack_import_2.isObject)(dataItem)) {
    dataItem = null;
  }
  if (dataItem) {
...
89528: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _SeriesDataSchema_js__rspack_import_1 = __webpack_require__(59480);
...
function enableDataStack(seriesModel, dimensionsInput, opt) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_0.each)(dimensionDefineList, function (dimensionInfo, index) {
    if ((0,zrender_lib_core_util_js__rspack_import_0.isString)(dimensionInfo)) {
  ...
  if (stackedDimInfo) {
    ...
    (0,zrender_lib_core_util_js__rspack_import_0.each)(dimensionDefineList, function (dimensionInfo) {
...
function isLegacyDimensionsInput(dimensionsInput) {
  return !(0,_SeriesDataSchema_js__rspack_import_1.isSeriesDataSchema)(dimensionsInput.schema);
}
...
5657: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var zrender_lib_core_util_js__rspack_import_0 = __webpack_require__(9774);
/* import */ var _util_log_js__rspack_import_2 = __webpack_require__(54137);
...
opt) {
  ...
  && !(0,zrender_lib_core_util_js__rspack_import_0.isNumber)(value) && value != null && value !== '-') {
    value = +(0,_util_number_js__rspack_import_1.parseDate)(value);
  }
...
;
var valueParserMap = (0,zrender_lib_core_util_js__rspack_import_0.createHashMap)({
  'number': function (val) {
  ...
  'time': function (val) {
    // return timestamp.
    return +(0,_util_number_js__rspack_import_1.parseDate)(val);
  },
  'trim': function (val) {
    return (0,zrender_lib_core_util_js__rspack_import_0.isString)(val) ? (0,zrender_lib_core_util_js__rspack_import_0.trim)(val) : val;
  }
});
...
var FilterOrderComparator = /** @class */function () {
  function FilterOrderComparator(op, rval) {
    if (!(0,zrender_lib_core_util_js__rspack_import_0.isNumber)(rval)) {
      var errMsg = '';
      if (false) {}
      (0,_util_log_js__rspack_import_2.throwError)(errMsg);
    }
    this._opFn = ORDER_COMPARISON_OP_MAP[op];
    this._rvalFloat = (0,_util_number_js__rspack_import_1.numericToNumber)(rval);
  }
  // Performance sensitive.
  FilterOrderComparator.prototype.evaluate = function (lval) {
    // Most cases is 'number', and typeof maybe 10 times faseter than parseFloat.
    return (0,zrender_lib_core_util_js__rspack_import_0.isNumber)(lval) ? this._opFn(lval, this._rvalFloat) : this._opFn((0,_util_number_js__rspack_import_1.numericToNumber)(lval), this._rvalFloat);
  };
...
var SortOrderComparator = /** @class */function () {
  ...
  SortOrderComparator.prototype.evaluate = function (lval, rval) {
    // Most cases is 'number', and typeof maybe 10 times faseter than parseFloat.
    var lvalFloat = (0,zrender_lib_core_util_js__rspack_import_0.isNumber)(lval) ? lval : (0,_util_number_js__rspack_import_1.numericToNumber)(lval);
    var rvalFloat = (0,zrender_lib_core_util_js__rspack_import_0.isNumber)(rval) ? rval : (0,_util_number_js__rspack_import_1.numericToNumber)(rval);
    ...
    if (lvalNotNumeric && rvalNotNumeric) {
      var lvalIsStr = (0,zrender_lib_core_util_js__rspack_import_0.isString)(lval);
      var rvalIsStr = (0,zrender_lib_core_util_js__rspack_import_0.isString)(rval);
      if (lvalIsStr) {
  ...
  FilterEqualityComparator.prototype.evaluate = function (lval) {
    ...
    if (!eqResult) {
      ...
      if (lvalTypeof !== this._rvalTypeof && (lvalTypeof === 'number' || this._rvalTypeof === 'number')) {
        eqResult = (0,_util_number_js__rspack_import_1.numericToNumber)(lval) === this._rvalFloat;
      }
    }
...
function createFilterComparator(op, rval) {
  return op === 'eq' || op === 'ne' ? new FilterEqualityComparator(op === 'eq', rval) : (0,zrender_lib_core_util_js__rspack_import_0.hasOwn)(ORDER_COMPARISON_OP_MAP, op) ? new FilterOrderComparator(op, rval) : null;
}

}),
180: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function summarizeDimensions(data, schema) {
  ...
  var notExtraCoordDimMap = (0,zrender_lib_core_util_js__rspack_import_0.createHashMap)();
  var defaultedLabel = [];
  var defaultedTooltip = [];
  var userOutputEncode = {};
  (0,zrender_lib_core_util_js__rspack_import_0.each)(data.dimensions, function (dimName) {
    ...
    _util_types_js__rspack_import_1.VISUAL_DIMENSIONS.each(function (v, otherDim) {
  ...
  summary.dataDimIndicesOnCoord = (0,zrender_lib_core_util_js__rspack_import_0.map)(dataDimsOnCoord, function (dimName) {
...
6579: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var zrender_lib_core_util_js__rspack_import_1 = __webpack_require__(9774);
/* import */ var _util_model_js__rspack_import_0 = __webpack_require__(67698);
...
function linkSeriesData(opt) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_1.each)(datas, function (data) {
    (0,zrender_lib_core_util_js__rspack_import_1.each)(mainData.TRANSFERABLE_METHODS, function (methodName) {
      data.wrapMethod(methodName, (0,zrender_lib_core_util_js__rspack_import_1.curry)(transferInjection, opt));
    });
  });
  // Beyond transfer, additional features should be added to `cloneShallow`.
  mainData.wrapMethod('cloneShallow', (0,zrender_lib_core_util_js__rspack_import_1.curry)(cloneShallowInjection, opt));
  // Only mainData trigger change, because struct.update may trigger
  // another changable methods, which may bring about dead lock.
  (0,zrender_lib_core_util_js__rspack_import_1.each)(mainData.CHANGABLE_METHODS, function (methodName) {
    mainData.wrapMethod(methodName, (0,zrender_lib_core_util_js__rspack_import_1.curry)(changeInjection, opt));
  });
  // Make sure datas contains mainData.
  (0,zrender_lib_core_util_js__rspack_import_1.assert)(datas[mainData.dataType] === mainData);
}
function transferInjection(opt, res) {
  if (isMainData(this)) {
    // Transfer datas to new main data.
    var datas = (0,zrender_lib_core_util_js__rspack_import_1.extend)({}, inner(this).datas);
...
function cloneShallowInjection(opt, res) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_1.each)(inner(res).datas, function (data, dataType) {
...
function getLinkedDataAll() {
  ...
  return mainData == null ? [{
    data: mainData
  }] : (0,zrender_lib_core_util_js__rspack_import_1.map)((0,zrender_lib_core_util_js__rspack_import_1.keys)(inner(mainData).datas), function (type) {
    return {
      type: type,
...
function linkAll(mainData, datas, opt) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_1.each)(datas, function (data, dataType) {
...
/* export default */ __webpack_exports__["default"] = (linkSeriesData);

}),
44055: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _util_model_js__rspack_import_0 = __webpack_require__(67698);
/* import */ var zrender_lib_core_util_js__rspack_import_1 = __webpack_require__(9774);
/* import */ var _util_types_js__rspack_import_2 = __webpack_require__(79390);
...
var innerGlobalModel = (0,_util_model_js__rspack_import_0.makeInner)();
/**
 * MUST be called before mergeOption of all series.
 */
function resetSourceDefaulter(ecModel) {
  // `datasetMap` is used to make default encode.
  innerGlobalModel(ecModel).datasetMap = (0,zrender_lib_core_util_js__rspack_import_1.createHashMap)();
}
/**
...
function makeSeriesEncodeForAxisCoordSys(coordDimensions, seriesModel, source) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_1.each)(coordDimensions, function (coordDimInfoLoose, coordDimIdx) {
    var coordDimInfo = (0,zrender_lib_core_util_js__rspack_import_1.isObject)(coordDimInfoLoose) ? coordDimInfoLoose : coordDimensions[coordDimIdx] = {
  ...
  (0,zrender_lib_core_util_js__rspack_import_1.each)(coordDimensions, function (coordDimInfo, coordDimIdx) {
...
function makeSeriesEncodeForNameBased(seriesModel, source, dimCount) {
  ...
  if (sourceFormat === _util_types_js__rspack_import_2.SOURCE_FORMAT_OBJECT_ROWS || sourceFormat === _util_types_js__rspack_import_2.SOURCE_FORMAT_KEYED_COLUMNS) {
    (0,zrender_lib_core_util_js__rspack_import_1.each)(dimensionsDefine, function (dim, idx) {
      if (((0,zrender_lib_core_util_js__rspack_import_1.isObject)(dim) ? dim.name : dim) === 'name') {
...
function querySeriesUpstreamDatasetModel(seriesModel) {
  ...
  if (!thisData) {
    return (0,_util_model_js__rspack_import_0.queryReferringComponents)(seriesModel.ecModel, 'dataset', {
      index: seriesModel.get('datasetIndex', true),
      id: seriesModel.get('datasetId', true)
    }, _util_model_js__rspack_import_0.SINGLE_REFERRING).models[0];
  }
}
/**
...
function queryDatasetUpstreamDatasetModels(datasetModel) {
  ...
  return (0,_util_model_js__rspack_import_0.queryReferringComponents)(datasetModel.ecModel, 'dataset', {
    index: datasetModel.get('fromDatasetIndex', true),
    id: datasetModel.get('fromDatasetId', true)
  }, _util_model_js__rspack_import_0.SINGLE_REFERRING).models;
}
/**
...
function doGuessOrdinal(data, sourceFormat, seriesLayoutBy, dimensionsDefine, startIndex, dimIndex) {
  ...
  // Experience value.
  var maxLoop = 5;
  if ((0,zrender_lib_core_util_js__rspack_import_1.isTypedArray)(data)) {
  ...
  if (dimensionsDefine) {
    ...
    if ((0,zrender_lib_core_util_js__rspack_import_1.isObject)(dimDefItem)) {
      dimName = dimDefItem.name;
      dimType = dimDefItem.type;
    } else if ((0,zrender_lib_core_util_js__rspack_import_1.isString)(dimDefItem)) {
      dimName = dimDefItem;
    }
  }
  if (dimType != null) {
  ...
  if (sourceFormat === _util_types_js__rspack_import_2.SOURCE_FORMAT_ARRAY_ROWS) {
    var dataArrayRows = data;
    if (seriesLayoutBy === _util_types_js__rspack_import_2.SERIES_LAYOUT_BY_ROW) {
  ...
  } else if (sourceFormat === _util_types_js__rspack_import_2.SOURCE_FORMAT_OBJECT_ROWS) {
  ...
  } else if (sourceFormat === _util_types_js__rspack_import_2.SOURCE_FORMAT_KEYED_COLUMNS) {
    var dataKeyedColumns = data;
    if (!dimName) {
      return BE_ORDINAL.Not;
    }
    var sample = dataKeyedColumns[dimName];
    if (!sample || (0,zrender_lib_core_util_js__rspack_import_1.isTypedArray)(sample)) {
      return BE_ORDINAL.Not;
    }
    for (var i = 0; i < sample.length && i < maxLoop; i++) {
  ...
  } else if (sourceFormat === _util_types_js__rspack_import_2.SOURCE_FORMAT_ORIGINAL) {
    var dataOriginal = data;
    for (var i = 0; i < dataOriginal.length && i < maxLoop; i++) {
      var item = dataOriginal[i];
      var val = (0,_util_model_js__rspack_import_0.getDataItemValue)(item);
      if (!(0,zrender_lib_core_util_js__rspack_import_1.isArray)(val)) {
        return BE_ORDINAL.Not;
      }
  ...
  function detectValue(val) {
    var beStr = (0,zrender_lib_core_util_js__rspack_import_1.isString)(val);
...
88404: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _Source_js__rspack_import_2 = __webpack_require__(24126);
/* import */ var _util_types_js__rspack_import_1 = __webpack_require__(79390);
/* import */ var _sourceHelper_js__rspack_import_6 = __webpack_require__(44055);
/* import */ var _transform_js__rspack_import_3 = __webpack_require__(90144);
/* import */ var _DataStore_js__rspack_import_4 = __webpack_require__(5746);
/* import */ var _dataProvider_js__rspack_import_5 = __webpack_require__(10403);
...
var SourceManager = /** @class */function () {
  ...
  SourceManager.prototype._createSource = function () {
    ...
    if (isSeries(sourceHost)) {
      ...
      // Series data is from own.
        ...
        sourceFormat = (0,zrender_lib_core_util_js__rspack_import_0.isTypedArray)(data) ? _util_types_js__rspack_import_1.SOURCE_FORMAT_TYPED_ARRAY : _util_types_js__rspack_import_1.SOURCE_FORMAT_ORIGINAL;
        upstreamSignList = [];
      }
      // See [REQUIREMENT_MEMO], merge settings on series and parent dataset if it is root.
      var newMetaRawOption = this._getSourceMetaRawOption() || {};
      var upMetaRawOption = upSource && upSource.metaRawOption || {};
      var seriesLayoutBy = (0,zrender_lib_core_util_js__rspack_import_0.retrieve2)(newMetaRawOption.seriesLayoutBy, upMetaRawOption.seriesLayoutBy) || null;
      var sourceHeader = (0,zrender_lib_core_util_js__rspack_import_0.retrieve2)(newMetaRawOption.sourceHeader, upMetaRawOption.sourceHeader);
      // Note here we should not use `upSource.dimensionsDefine`. Consider the case:
      // `upSource.dimensionsDefine` is detected by `seriesLayoutBy: 'column'`,
      // but series need `seriesLayoutBy: 'row'`.
      var dimensions = (0,zrender_lib_core_util_js__rspack_import_0.retrieve2)(newMetaRawOption.dimensions, upMetaRawOption.dimensions);
      ...
      resultSourceList = needsCreateSource ? [(0,_Source_js__rspack_import_2.createSource)(data, {
      ...
      // Is root dataset.
        ...
        resultSourceList = [(0,_Source_js__rspack_import_2.createSource)(sourceData, this._getSourceMetaRawOption(), null)];
        upstreamSignList = [];
      }
    }
    if (false) {}
  ...
  SourceManager.prototype._applyTransform = function (upMgrList) {
    ...
    var upSourceList = [];
    var upstreamSignList = [];
    (0,zrender_lib_core_util_js__rspack_import_0.each)(upMgrList, function (upMgr) {
      upMgr.prepareSource();
    ...
    if (transformOption) {
      sourceList = (0,_transform_js__rspack_import_3.applyDataTransform)(transformOption, upSourceList, {
        datasetIndex: datasetModel.componentIndex
      });
    } else if (fromTransformResult != null) {
      sourceList = [(0,_Source_js__rspack_import_2.cloneSourceShallow)(upSourceList[0])];
    }
    return {
  ...
  SourceManager.prototype._innerGetDataStore = function (storeDims, seriesSource, sourceReadKey) {
    ...
    if (!cachedStore) {
      ...
      if (isSeries(this._sourceHost) && upSourceMgr) {
        ...
        cachedStore = new _DataStore_js__rspack_import_4["default"]();
        // Always create store from source of series.
        cachedStore.initData(new _dataProvider_js__rspack_import_5.DefaultDataProvider(seriesSource, storeDims.length), storeDims);
      }
  ...
  SourceManager.prototype._getUpstreamSourceManagers = function () {
    ...
    var sourceHost = this._sourceHost;
    if (isSeries(sourceHost)) {
      var datasetModel = (0,_sourceHelper_js__rspack_import_6.querySeriesUpstreamDatasetModel)(sourceHost);
      return !datasetModel ? [] : [datasetModel.getSourceManager()];
    } else {
      return (0,zrender_lib_core_util_js__rspack_import_0.map)((0,_sourceHelper_js__rspack_import_6.queryDatasetUpstreamDatasetModels)(sourceHost), function (datasetModel) {
...
function disableTransformOptionMerge(datasetModel) {
  ...
  transformOption && (0,zrender_lib_core_util_js__rspack_import_0.setAsPrimitive)(datasetModel.option.transform);
}
...
90144: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _dataProvider_js__rspack_import_4 = __webpack_require__(10403);
/* import */ var _dataValueHelper_js__rspack_import_0 = __webpack_require__(5657);
/* import */ var _util_log_js__rspack_import_2 = __webpack_require__(54137);
/* import */ var _Source_js__rspack_import_6 = __webpack_require__(24126);
...
var ExternalSource = /** @class */function () {
  ...
  ExternalSource.prototype.convertValue = function (rawVal, dimInfo) {
    return (0,_dataValueHelper_js__rspack_import_0.parseDataValue)(rawVal, dimInfo);
  };
...
function createExternalSource(internalSource, externalTransform) {
  ...
  var errMsg = '';
  if (internalSource.seriesLayoutBy !== _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN) {
  ...
  if (dimsDef) {
    (0,zrender_lib_core_util_js__rspack_import_3.each)(dimsDef, function (dimDef, idx) {
      ...
      if (name != null) {
        ...
        var errMsg_1 = '';
        if ((0,zrender_lib_core_util_js__rspack_import_3.hasOwn)(dimsByName, name)) {
          if (false) {}
          (0,_util_log_js__rspack_import_2.throwError)(errMsg_1);
        }
  ...
  var rawItemGetter = (0,_dataProvider_js__rspack_import_4.getRawSourceItemGetter)(sourceFormat, _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN);
  if (externalTransform.__isBuiltIn) {
    extSource.getRawDataItem = function (dataIndex) {
      return rawItemGetter(data, sourceHeaderCount, dimensions, dataIndex);
    };
    extSource.getRawData = (0,zrender_lib_core_util_js__rspack_import_3.bind)(getRawData, null, internalSource);
  }
  extSource.cloneRawData = (0,zrender_lib_core_util_js__rspack_import_3.bind)(cloneRawData, null, internalSource);
  var rawCounter = (0,_dataProvider_js__rspack_import_4.getRawSourceDataCounter)(sourceFormat, _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN);
  extSource.count = (0,zrender_lib_core_util_js__rspack_import_3.bind)(rawCounter, null, data, sourceHeaderCount, dimensions);
  var rawValueGetter = (0,_dataProvider_js__rspack_import_4.getRawSourceValueGetter)(sourceFormat);
  ...
  extSource.getDimensionInfo = (0,zrender_lib_core_util_js__rspack_import_3.bind)(getDimensionInfo, null, dimensions, dimsByName);
  extSource.cloneAllDimensionInfo = (0,zrender_lib_core_util_js__rspack_import_3.bind)(cloneAllDimensionInfo, null, dimensions);
  return extSource;
}
...
function cloneRawData(upstream) {
  ...
  if (sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS) {
    var result = [];
    ...
    return result;
  } else if (sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS) {
    var result = [];
    for (var i = 0, len = data.length; i < len; i++) {
      // Not strictly clone for performance
      result.push((0,zrender_lib_core_util_js__rspack_import_3.extend)({}, data[i]));
    }
    return result;
  }
}
function getDimensionInfo(dimensions, dimsByName, dim) {
  ...
  if ((0,zrender_lib_core_util_js__rspack_import_3.isNumber)(dim)
  // If being a number-like string but not being defined a dimension name.
  || !isNaN(dim) && !(0,zrender_lib_core_util_js__rspack_import_3.hasOwn)(dimsByName, dim)) {
    return dimensions[dim];
  } else if ((0,zrender_lib_core_util_js__rspack_import_3.hasOwn)(dimsByName, dim)) {
    return dimsByName[dim];
  }
}
function cloneAllDimensionInfo(dimensions) {
  return (0,zrender_lib_core_util_js__rspack_import_3.clone)(dimensions);
}
var externalTransformMap = (0,zrender_lib_core_util_js__rspack_import_3.createHashMap)();
function registerExternalTransform(externalTransform) {
  externalTransform = (0,zrender_lib_core_util_js__rspack_import_3.clone)(externalTransform);
...
function applyDataTransform(rawTransOption, sourceList, infoForPrint) {
  var pipedTransOption = (0,_util_model_js__rspack_import_5.normalizeToArray)(rawTransOption);
...
pipeIndex) {
  ...
  if (!(0,zrender_lib_core_util_js__rspack_import_3.isObject)(transOption)) {
    if (false) {}
    (0,_util_log_js__rspack_import_2.throwError)(errMsg);
  }
  ...
  // Prepare source
  var extUpSourceList = (0,zrender_lib_core_util_js__rspack_import_3.map)(upSourceList, function (upSource) {
    return createExternalSource(upSource, externalTransform);
  });
  var resultList = (0,_util_model_js__rspack_import_5.normalizeToArray)(externalTransform.transform({
    upstream: extUpSourceList[0],
    upstreamList: extUpSourceList,
    config: (0,zrender_lib_core_util_js__rspack_import_3.clone)(transOption.config)
  }));
  if (false) { var printStrArr }
  return (0,zrender_lib_core_util_js__rspack_import_3.map)(resultList, function (result, resultIndex) {
    var errMsg = '';
    if (!(0,zrender_lib_core_util_js__rspack_import_3.isObject)(result)) {
      if (false) {}
      (0,_util_log_js__rspack_import_2.throwError)(errMsg);
    }
    if (!result.data) {
    ...
    var sourceFormat = (0,_Source_js__rspack_import_6.detectSourceFormat)(result.data);
    if (!isSupportedSourceFormat(sourceFormat)) {
      if (false) {}
      (0,_util_log_js__rspack_import_2.throwError)(errMsg);
    }
    ...
    && !result.dimensions) {
      ...
      resultMetaRawOption = {
        seriesLayoutBy: _util_types_js__rspack_import_1.SERIES_LAYOUT_BY_COLUMN,
    ...
    return (0,_Source_js__rspack_import_6.createSource)(result.data, resultMetaRawOption, null);
  });
}
function isSupportedSourceFormat(sourceFormat) {
  return sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_ARRAY_ROWS || sourceFormat === _util_types_js__rspack_import_1.SOURCE_FORMAT_OBJECT_ROWS;
}

}),
71586: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var createDimensions = __webpack_require__(24079);
...
var time = __webpack_require__(24566);
...
var Ellipse = __webpack_require__(79981);
...
var canvas_graphic = __webpack_require__(96111);
...
51799: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  use: function() { return use; }
});
/* import */ var _core_echarts_js__rspack_import_0 = __webpack_require__(8741);
/* import */ var _view_Component_js__rspack_import_3 = __webpack_require__(95421);
/* import */ var _view_Chart_js__rspack_import_5 = __webpack_require__(7426);
/* import */ var _model_Component_js__rspack_import_2 = __webpack_require__(53075);
/* import */ var _model_Series_js__rspack_import_4 = __webpack_require__(32019);
/* import */ var zrender_lib_core_util_js__rspack_import_8 = __webpack_require__(9774);
/* import */ var _core_impl_js__rspack_import_1 = __webpack_require__(18816);
/* import */ var zrender_lib_zrender_js__rspack_import_7 = __webpack_require__(80151);
/* import */ var _chart_custom_customSeriesRegister_js__rspack_import_6 = __webpack_require__(15462);
...
var extensionRegisters = {
  registerPreprocessor: _core_echarts_js__rspack_import_0.registerPreprocessor,
  registerProcessor: _core_echarts_js__rspack_import_0.registerProcessor,
  registerPostInit: _core_echarts_js__rspack_import_0.registerPostInit,
  registerPostUpdate: _core_echarts_js__rspack_import_0.registerPostUpdate,
  registerUpdateLifecycle: _core_echarts_js__rspack_import_0.registerUpdateLifecycle,
  registerAction: _core_echarts_js__rspack_import_0.registerAction,
  registerCoordinateSystem: _core_echarts_js__rspack_import_0.registerCoordinateSystem,
  registerLayout: _core_echarts_js__rspack_import_0.registerLayout,
  registerVisual: _core_echarts_js__rspack_import_0.registerVisual,
  registerTransform: _core_echarts_js__rspack_import_0.registerTransform,
  registerLoading: _core_echarts_js__rspack_import_0.registerLoading,
  registerMap: _core_echarts_js__rspack_import_0.registerMap,
  registerImpl: _core_impl_js__rspack_import_1.registerImpl,
  PRIORITY: _core_echarts_js__rspack_import_0.PRIORITY,
  ComponentModel: _model_Component_js__rspack_import_2["default"],
  ComponentView: _view_Component_js__rspack_import_3["default"],
  SeriesModel: _model_Series_js__rspack_import_4["default"],
  ChartView: _view_Chart_js__rspack_import_5["default"],
  // TODO Use ComponentModel and SeriesModel instead of Constructor
  registerComponentModel: function (ComponentModelClass) {
    _model_Component_js__rspack_import_2["default"].registerClass(ComponentModelClass);
  },
  registerComponentView: function (ComponentViewClass) {
    _view_Component_js__rspack_import_3["default"].registerClass(ComponentViewClass);
  },
  registerSeriesModel: function (SeriesModelClass) {
    _model_Series_js__rspack_import_4["default"].registerClass(SeriesModelClass);
  },
  registerChartView: function (ChartViewClass) {
    _view_Chart_js__rspack_import_5["default"].registerClass(ChartViewClass);
  },
  registerCustomSeries: function (seriesType, renderItem) {
    (0,_chart_custom_customSeriesRegister_js__rspack_import_6.registerCustomSeries)(seriesType, renderItem);
  },
  registerSubTypeDefaulter: function (componentType, defaulter) {
    _model_Component_js__rspack_import_2["default"].registerSubTypeDefaulter(componentType, defaulter);
  },
  registerPainter: function (painterType, PainterCtor) {
    (0,zrender_lib_zrender_js__rspack_import_7.registerPainter)(painterType, PainterCtor);
  }
};
function use(ext) {
  if ((0,zrender_lib_core_util_js__rspack_import_8.isArray)(ext)) {
    // use([ChartLine, ChartBar]);
    (0,zrender_lib_core_util_js__rspack_import_8.each)(ext, function (singleExt) {
      use(singleExt);
    });
    return;
  }
  if ((0,zrender_lib_core_util_js__rspack_import_8.indexOf)(extensions, ext) >= 0) {
    return;
  }
  extensions.push(ext);
  if ((0,zrender_lib_core_util_js__rspack_import_8.isFunction)(ext)) {
    ext = {
      install: ext
    };
  }
...
92044: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
...
55449: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
