 ...
 */
"use strict";
(self["webpackChunkvue_admin_better"] = self["webpackChunkvue_admin_better"] || []).push([["8278"], {
53791: (function (__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
65736: (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".stock-container[data-v-0039098a]{padding:20px}.stock-card[data-v-0039098a]{min-height:800px}.stock-info[data-v-0039098a]{display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;padding:15px;background-color:#f5f7fa;border-radius:4px}.price-section[data-v-0039098a]{flex:1}.current-price[data-v-0039098a]{font-size:24px;margin-bottom:10px}.current-price .price[data-v-0039098a]{font-weight:bold;margin-right:15px}.current-price .change[data-v-0039098a]{font-size:16px}.current-price .change.increase[data-v-0039098a]{color:#f56c6c}.current-price .change.decrease[data-v-0039098a]{color:#67c23a}.price-details[data-v-0039098a]{display:flex;gap:30px}.price-details div[data-v-0039098a]{font-size:14px;color:#606266}.chart-container[data-v-0039098a]{margin-top:30px;height:400px}.echarts-chart[data-v-0039098a]{width:100%;height:100%}.disclaimer[data-v-0039098a]{padding:15px;background-color:#fff3f3;border-radius:4px;border-left:4px solid #f56c6c}.disclaimer .disclaimer-content h4[data-v-0039098a]{margin-top:10px;color:#f56c6c;margin-bottom:10px;font-size:16px}.disclaimer .disclaimer-content p[data-v-0039098a]{margin:5px 0;font-size:14px;color:#606266;line-height:1.5}", ""]);
// Exports
/* export default */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);


}),
20709: (function (__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var update = injectStylesIntoStyleTag_default()(stockvue_type_style_index_0_id_0039098a_lang_scss_scoped_true_["default"], options);




       /* export default */ var views_stockvue_type_style_index_0_id_0039098a_lang_scss_scoped_true_ = (stockvue_type_style_index_0_id_0039098a_lang_scss_scoped_true_["default"] && stockvue_type_style_index_0_id_0039098a_lang_scss_scoped_true_["default"].locals ? stockvue_type_style_index_0_id_0039098a_lang_scss_scoped_true_["default"].locals : undefined);

;// CONCATENATED MODULE: ./src/views/stock/index.vue?vue&type=style&index=0&id=0039098a&lang=scss&scoped=true&
