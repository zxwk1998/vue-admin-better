 ...
 */
"use strict";
(self["webpackChunkvue_admin_better"] = self["webpackChunkvue_admin_better"] || []).push([["4375"], {
7339: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var visual_aria = __webpack_require__(28442);
...
71777: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
...
/* import */ var _util_graphic_js__rspack_import_4 = __webpack_require__(98577);
/* import */ var _util_graphic_js__rspack_import_5 = __webpack_require__(38401);
/* import */ var _util_graphic_js__rspack_import_7 = __webpack_require__(62070);
/* import */ var _util_graphic_js__rspack_import_11 = __webpack_require__(98528);
/* import */ var _label_labelStyle_js__rspack_import_9 = __webpack_require__(51160);
/* import */ var _model_Model_js__rspack_import_6 = __webpack_require__(37931);
/* import */ var _AxisView_js__rspack_import_0 = __webpack_require__(40616);
/* import */ var _AxisBuilder_js__rspack_import_8 = __webpack_require__(45430);
/* import */ var _util_innerStore_js__rspack_import_10 = __webpack_require__(61022);
...
var AngleAxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(AngleAxisView, _super);
  ...
  AngleAxisView.prototype.render = function (angleAxisModel, ecModel) {
    ...
    var labels = zrender_lib_core_util_js__rspack_import_2.map(angleAxis.getViewLabels(), function (labelItem) {
      labelItem = zrender_lib_core_util_js__rspack_import_2.clone(labelItem);
    ...
    zrender_lib_core_util_js__rspack_import_2.each(elementList, function (name) {
...
}(_AxisView_js__rspack_import_0["default"]);
var angelAxisElementsBuilders = {
  axisLine: function (group, angleAxisModel, polar, ticksAngles, minorTickAngles, radiusExtent) {
    ...
    if (radiusExtent[r0Id] === 0) {
      shape = new _util_graphic_js__rspack_import_3[shapeType]({
        shape: {
          cx: polar.cx,
          cy: polar.cy,
          r: radiusExtent[rId],
      ...
      shape = new _util_graphic_js__rspack_import_4["default"]({
        shape: {
          cx: polar.cx,
          cy: polar.cy,
          r: radiusExtent[rId],
  ...
  axisTick: function (group, angleAxisModel, polar, ticksAngles, minorTickAngles, radiusExtent) {
    ...
    var lines = zrender_lib_core_util_js__rspack_import_2.map(ticksAngles, function (tickAngleItem) {
      return new _util_graphic_js__rspack_import_5["default"]({
        shape: getAxisLineShape(polar, [radius, radius + tickLen], tickAngleItem.coord)
      });
    });
    group.add(_util_graphic_js__rspack_import_3.mergePath(lines, {
      style: zrender_lib_core_util_js__rspack_import_2.defaults(tickModel.getModel('lineStyle').getLineStyle(), {
  ...
  minorTick: function (group, angleAxisModel, polar, tickAngles, minorTickAngles, radiusExtent) {
    ...
    for (var i = 0; i < minorTickAngles.length; i++) {
      for (var k = 0; k < minorTickAngles[i].length; k++) {
        lines.push(new _util_graphic_js__rspack_import_5["default"]({
          shape: getAxisLineShape(polar, [radius, radius + tickLen], minorTickAngles[i][k].coord)
        }));
      }
    }
    group.add(_util_graphic_js__rspack_import_3.mergePath(lines, {
      style: zrender_lib_core_util_js__rspack_import_2.defaults(minorTickModel.getModel('lineStyle').getLineStyle(), zrender_lib_core_util_js__rspack_import_2.defaults(tickModel.getLineStyle(), {
        stroke: angleAxisModel.get(['axisLine', 'lineStyle', 'color'])
      }))
    }));
  },
  axisLabel: function (group, angleAxisModel, polar, ticksAngles, minorTickAngles, radiusExtent, labels) {
    ...
    zrender_lib_core_util_js__rspack_import_2.each(labels, function (labelItem, idx) {
      ...
      if (rawCategoryData && rawCategoryData[tickValue]) {
        ...
        if (zrender_lib_core_util_js__rspack_import_2.isObject(rawCategoryItem) && rawCategoryItem.textStyle) {
          labelModel = new _model_Model_js__rspack_import_6["default"](rawCategoryItem.textStyle, commonLabelModel, commonLabelModel.ecModel);
        }
      }
      var textEl = new _util_graphic_js__rspack_import_7["default"]({
        silent: _AxisBuilder_js__rspack_import_8["default"].isLabelSilent(angleAxisModel),
        style: (0,_label_labelStyle_js__rspack_import_9.createTextStyle)(labelModel, {
          x: p[0],
          y: p[1],
      ...
      group.add(textEl);
      _util_graphic_js__rspack_import_3.setTooltipConfig({
        el: textEl,
      ...
      if (triggerEvent) {
        var eventData = _AxisBuilder_js__rspack_import_8["default"].makeAxisEventDataBase(angleAxisModel);
        eventData.targetType = 'axisLabel';
        eventData.value = labelItem.rawLabel;
        (0,_util_innerStore_js__rspack_import_10.getECData)(textEl).eventData = eventData;
      }
    }, this);
  },
  splitLine: function (group, angleAxisModel, polar, ticksAngles, minorTickAngles, radiusExtent) {
    ...
    for (var i = 0; i < ticksAngles.length; i++) {
      ...
      splitLines[colorIndex].push(new _util_graphic_js__rspack_import_5["default"]({
    ...
    for (var i = 0; i < splitLines.length; i++) {
      group.add(_util_graphic_js__rspack_import_3.mergePath(splitLines[i], {
        style: zrender_lib_core_util_js__rspack_import_2.defaults({
  ...
  splitArea: function (group, angleAxisModel, polar, ticksAngles, minorTickAngles, radiusExtent) {
    ...
    for (var i = 1, len = ticksAngles.length; i <= len; i++) {
      ...
      splitAreas[colorIndex].push(new _util_graphic_js__rspack_import_11["default"]({
        shape: {
          cx: polar.cx,
          cy: polar.cy,
          r0: r0,
    ...
    for (var i = 0; i < splitAreas.length; i++) {
      group.add(_util_graphic_js__rspack_import_3.mergePath(splitAreas[i], {
        style: zrender_lib_core_util_js__rspack_import_2.defaults({
...
/* export default */ __webpack_exports__["default"] = (AngleAxisView);

}),
45430: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var zrender_lib_core_util_js__rspack_import_2 = __webpack_require__(9774);
/* import */ var _util_graphic_js__rspack_import_7 = __webpack_require__(97786);
/* import */ var _util_graphic_js__rspack_import_11 = __webpack_require__(38401);
/* import */ var _util_graphic_js__rspack_import_12 = __webpack_require__(9412);
/* import */ var _util_graphic_js__rspack_import_15 = __webpack_require__(62070);
/* import */ var _util_graphic_js__rspack_import_20 = __webpack_require__(52721);
/* import */ var _util_innerStore_js__rspack_import_17 = __webpack_require__(61022);
/* import */ var _label_labelStyle_js__rspack_import_16 = __webpack_require__(51160);
/* import */ var _model_Model_js__rspack_import_18 = __webpack_require__(37931);
/* import */ var _util_number_js__rspack_import_8 = __webpack_require__(64782);
/* import */ var _util_symbol_js__rspack_import_13 = __webpack_require__(40991);
/* import */ var zrender_lib_core_matrix_js__rspack_import_4 = __webpack_require__(46239);
/* import */ var zrender_lib_core_vector_js__rspack_import_9 = __webpack_require__(44721);
/* import */ var _coord_axisHelper_js__rspack_import_1 = __webpack_require__(62159);
/* import */ var _label_labelLayoutHelper_js__rspack_import_3 = __webpack_require__(86031);
/* import */ var _util_model_js__rspack_import_0 = __webpack_require__(67698);
/* import */ var _axisBreakHelper_js__rspack_import_10 = __webpack_require__(874);
/* import */ var _axisAction_js__rspack_import_21 = __webpack_require__(11943);
/* import */ var _scale_break_js__rspack_import_22 = __webpack_require__(8188);
/* import */ var zrender_lib_core_BoundingRect_js__rspack_import_5 = __webpack_require__(7544);
/* import */ var zrender_lib_core_Point_js__rspack_import_6 = __webpack_require__(97270);
/* import */ var zrender_lib_core_Transformable_js__rspack_import_19 = __webpack_require__(30128);
/* import */ var _coord_axisTickLabelBuilder_js__rspack_import_14 = __webpack_require__(59511);
...
var getLabelInner = (0,_util_model_js__rspack_import_0.makeInner)();
var getTickInner = (0,_util_model_js__rspack_import_0.makeInner)();
/**
...
function resetOverlapRecordToShared(cfg, shared, axisModel, labelLayoutList) {
  ...
  var labelInfoList = [];
  var stOccupiedRect;
  var useStOccupiedRect = hasAxisName(cfg.axisName) && (0,_coord_axisHelper_js__rspack_import_1.isNameLocationCenter)(cfg.nameLocation);
  (0,zrender_lib_core_util_js__rspack_import_2.each)(labelLayoutList, function (layout) {
    var layoutInfo = (0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)(layout);
    ...
    if (useStOccupiedRect) {
      ...
      transGroup.transform ? zrender_lib_core_matrix_js__rspack_import_4.invert(_stTransTmp, transGroup.transform) : zrender_lib_core_matrix_js__rspack_import_4.identity(_stTransTmp);
      if (layoutInfo.transform) {
        zrender_lib_core_matrix_js__rspack_import_4.mul(_stTransTmp, _stTransTmp, layoutInfo.transform);
      }
      zrender_lib_core_BoundingRect_js__rspack_import_5["default"].copy(_stLabelRectTmp, layoutInfo.localRect);
      _stLabelRectTmp.applyTransform(_stTransTmp);
      stOccupiedRect ? stOccupiedRect.union(_stLabelRectTmp) : zrender_lib_core_BoundingRect_js__rspack_import_5["default"].copy(stOccupiedRect = new zrender_lib_core_BoundingRect_js__rspack_import_5["default"](0, 0, 0, 0), _stLabelRectTmp);
    }
  });
  ...
  if (useStOccupiedRect && stOccupiedRect) {
    ...
    stOccupiedRect.union(new zrender_lib_core_BoundingRect_js__rspack_import_5["default"](axisLineX, 0, axisLineWidth, 1));
  }
  record.stOccupiedRect = stOccupiedRect;
  record.labelInfoList = labelInfoList;
}
var _stTransTmp = zrender_lib_core_matrix_js__rspack_import_4.create();
var _stLabelRectTmp = new zrender_lib_core_BoundingRect_js__rspack_import_5["default"](0, 0, 0, 0);
/**
...
var resolveAxisNameOverlapDefault = function (cfg, ctx, axisModel, nameLayoutInfo, nameMoveDirVec, thisRecord) {
  if ((0,_coord_axisHelper_js__rspack_import_1.isNameLocationCenter)(cfg.nameLocation)) {
    var stOccupiedRect = thisRecord.stOccupiedRect;
    if (stOccupiedRect) {
      moveIfOverlap((0,_label_labelLayoutHelper_js__rspack_import_3.computeLabelGeometry2)({}, stOccupiedRect, thisRecord.transGroup.transform), nameLayoutInfo, nameMoveDirVec);
    }
  } else {
...
function moveIfOverlap(basedLayoutInfo, movableLayoutInfo, moveDirVec) {
  var mtv = new zrender_lib_core_Point_js__rspack_import_6["default"]();
  if ((0,_label_labelLayoutHelper_js__rspack_import_3.labelIntersect)(basedLayoutInfo, movableLayoutInfo, mtv, {
    direction: Math.atan2(moveDirVec.y, moveDirVec.x),
    bidirectional: false,
    touchThreshold: 0.05
  })) {
    (0,_label_labelLayoutHelper_js__rspack_import_3.labelLayoutApplyTranslation)(movableLayoutInfo, mtv);
  }
}
function moveIfOverlapByLinearLabels(baseLayoutInfoList, baseDirVec, movableLayoutInfo, moveDirVec) {
  ...
  var sameDir = zrender_lib_core_Point_js__rspack_import_6["default"].dot(moveDirVec, baseDirVec) >= 0;
...
var AxisBuilder = /** @class */function () {
  ...
  function AxisBuilder(axisModel, api, opt, shared) {
    this.group = new _util_graphic_js__rspack_import_7["default"]();
  ...
  AxisBuilder.prototype._resetCfgDetermined = function (raw) {
    ...
    // Default value
    var axisName = (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(raw.axisName, axisModel.get('name'));
    var nameMoveOverlapOption = axisModel.get('nameMoveOverlap');
    if (nameMoveOverlapOption == null || nameMoveOverlapOption === 'auto') {
      nameMoveOverlapOption = (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(raw.defaultNameMoveOverlap, true);
    }
    var cfg = {
      raw: raw,
      position: raw.position,
      rotation: raw.rotation,
      nameDirection: (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(raw.nameDirection, 1),
      tickDirection: (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(raw.tickDirection, 1),
      labelDirection: (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(raw.labelDirection, 1),
      labelOffset: (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(raw.labelOffset, 0),
      silent: (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(raw.silent, true),
      axisName: axisName,
      nameLocation: (0,zrender_lib_core_util_js__rspack_import_2.retrieve3)(axisModel.get('nameLocation'), axisModelDefaultOption.nameLocation, 'end'),
    ...
    var transformGroup = new _util_graphic_js__rspack_import_7["default"]({
      x: cfg.position[0],
      y: cfg.position[1],
    ...
    record.dirVec = new zrender_lib_core_Point_js__rspack_import_6["default"](Math.cos(-cfg.rotation), Math.sin(-cfg.rotation));
  };
  AxisBuilder.prototype.build = function (axisPartNameMap, extraParams) {
    ...
    (0,zrender_lib_core_util_js__rspack_import_2.each)(AXIS_BUILDER_AXIS_PART_NAMES, function (partName) {
  ...
  AxisBuilder.innerTextLayout = function (axisRotation, textRotation, direction) {
    var rotationDiff = (0,_util_number_js__rspack_import_8.remRadian)(textRotation - axisRotation);
    var textAlign;
    var textVerticalAlign;
    if ((0,_util_number_js__rspack_import_8.isRadianAroundZero)(rotationDiff)) {
      // Label is parallel with axis line.
      textVerticalAlign = direction > 0 ? 'top' : 'bottom';
      textAlign = 'center';
    } else if ((0,_util_number_js__rspack_import_8.isRadianAroundZero)(rotationDiff - PI)) {
...
var builders = {
  axisLine: function (cfg, local, shared, axisModel, group, transformGroup, api) {
    ...
    if (matrix) {
      (0,zrender_lib_core_vector_js__rspack_import_9.applyTransform)(pt1, pt1, matrix);
      (0,zrender_lib_core_vector_js__rspack_import_9.applyTransform)(pt2, pt2, matrix);
    }
    var lineStyle = (0,zrender_lib_core_util_js__rspack_import_2.extend)({
      lineCap: 'round'
    ...
    if (axisModel.get(['axisLine', 'breakLine']) && axisModel.axis.scale.hasBreaks()) {
      (0,_axisBreakHelper_js__rspack_import_10.getAxisBreakHelper)().buildAxisBreakLine(axisModel, group, transformGroup, pathBaseProp);
    } else {
      var line = new _util_graphic_js__rspack_import_11["default"]((0,zrender_lib_core_util_js__rspack_import_2.extend)({
        shape: {
          x1: pt1[0],
          y1: pt1[1],
          x2: pt2[0],
      ...
      _util_graphic_js__rspack_import_12.subPixelOptimizeLine(line.shape, line.style.lineWidth);
      line.anid = 'line';
      group.add(line);
    }
    ...
    if (arrows != null) {
      ...
      if ((0,zrender_lib_core_util_js__rspack_import_2.isString)(arrows)) {
        // Use the same arrow for start and end point
        arrows = [arrows, arrows];
      }
      if ((0,zrender_lib_core_util_js__rspack_import_2.isString)(arrowSize) || (0,zrender_lib_core_util_js__rspack_import_2.isNumber)(arrowSize)) {
        // Use the same size for width and height
        arrowSize = [arrowSize, arrowSize];
      }
      var arrowOffset = (0,_util_symbol_js__rspack_import_13.normalizeSymbolOffset)(axisModel.get(['axisLine', 'symbolOffset']) || 0, arrowSize);
      var symbolWidth_1 = arrowSize[0];
      var symbolHeight_1 = arrowSize[1];
      (0,zrender_lib_core_util_js__rspack_import_2.each)([{
        ...
        if (arrows[index] !== 'none' && arrows[index] != null) {
          var symbol = (0,_util_symbol_js__rspack_import_13.createSymbol)(arrows[index], -symbolWidth_1 / 2, -symbolHeight_1 / 2, symbolWidth_1, symbolHeight_1, lineStyle.stroke, true);
  ...
  axisTickLabelEstimate: function (cfg, local, shared, axisModel, group, transformGroup, api, extraParams) {
    ...
    if (needCallLayout) {
      layOutAxisTickLabel(cfg, local, shared, axisModel, group, transformGroup, api, _coord_axisTickLabelBuilder_js__rspack_import_14.AxisTickLabelComputingKind.estimate);
    }
  },
  /**
  ...
  axisTickLabelDetermine: function (cfg, local, shared, axisModel, group, transformGroup, api, extraParams) {
    ...
    var needCallLayout = dealLastTickLabelResultReusable(local, group, extraParams);
    if (needCallLayout) {
      layOutAxisTickLabel(cfg, local, shared, axisModel, group, transformGroup, api, _coord_axisTickLabelBuilder_js__rspack_import_14.AxisTickLabelComputingKind.determine);
    }
  ...
  axisName: function (cfg, local, shared, axisModel, group, transformGroup, api, extraParams) {
    ...
    var pos = new zrender_lib_core_Point_js__rspack_import_6["default"](0, 0);
    var nameMoveDirVec = new zrender_lib_core_Point_js__rspack_import_6["default"](0, 0);
    ...
    var mt = zrender_lib_core_matrix_js__rspack_import_4.create();
    nameMoveDirVec.transform(zrender_lib_core_matrix_js__rspack_import_4.rotate(mt, mt, cfg.rotation));
    ...
    if ((0,_coord_axisHelper_js__rspack_import_1.isNameLocationCenter)(nameLocation)) {
    ...
    var maxWidth = (0,zrender_lib_core_util_js__rspack_import_2.retrieve)(cfg.raw.nameTruncateMaxWidth, truncateOpt.maxWidth, axisNameAvailableWidth);
    var nameMarginLevel = extraParams.nameMarginLevel || 0;
    var textEl = new _util_graphic_js__rspack_import_15["default"]({
      x: pos.x,
      y: pos.y,
      rotation: labelLayout.rotation,
      silent: AxisBuilder.isLabelSilent(axisModel),
      style: (0,_label_labelStyle_js__rspack_import_16.createTextStyle)(textStyleModel, {
        text: name,
        font: textFont,
        overflow: 'truncate',
        width: maxWidth,
    ...
    _util_graphic_js__rspack_import_12.setTooltipConfig({
      el: textEl,
    ...
    if (axisModel.get('triggerEvent')) {
      ...
      eventData.name = name;
      (0,_util_innerStore_js__rspack_import_17.getECData)(textEl).eventData = eventData;
    }
    transformGroup.add(textEl);
    textEl.updateTransform();
    local.nameEl = textEl;
    var nameLayout = sharedRecord.nameLayout = (0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)({
      label: textEl,
      priority: textEl.z2,
      defaultAttr: {
        ignore: textEl.ignore
      },
      marginDefault: (0,_coord_axisHelper_js__rspack_import_1.isNameLocationCenter)(nameLocation)
...
function layOutAxisTickLabel(cfg, local, shared, axisModel, group, transformGroup, api, kind) {
  ...
  if (optionHideOverlap) {
    ...
    (0,_label_labelLayoutHelper_js__rspack_import_3.hideOverlap)(
    // Filter the already ignored labels by the previous overlap resolving methods.
    (0,zrender_lib_core_util_js__rspack_import_2.filter)(labelLayoutList, function (layout) {
...
function endTextLayout(rotation, textPosition, textRotate, extent) {
  var rotationDiff = (0,_util_number_js__rspack_import_8.remRadian)(textRotate - rotation);
  var textAlign;
  var textVerticalAlign;
  var inverse = extent[0] > extent[1];
  var onLeft = textPosition === 'start' && !inverse || textPosition !== 'start' && inverse;
  if ((0,_util_number_js__rspack_import_8.isRadianAroundZero)(rotationDiff - PI / 2)) {
    textVerticalAlign = onLeft ? 'bottom' : 'top';
    textAlign = 'center';
  } else if ((0,_util_number_js__rspack_import_8.isRadianAroundZero)(rotationDiff - PI * 1.5)) {
...
function fixMinMaxLabelShow(axisModel, labelLayoutList, optionHideOverlap) {
  if ((0,_coord_axisHelper_js__rspack_import_1.shouldShowAllLabels)(axisModel.axis)) {
    return;
  }
  // FIXME
  ...
  function deal(showMinMaxLabel, outmostLabelIdx, innerLabelIdx) {
    var outmostLabelLayout = (0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)(labelLayoutList[outmostLabelIdx]);
    var innerLabelLayout = (0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)(labelLayoutList[innerLabelIdx]);
    ...
    if (!optionHideOverlap) {
      ...
      outmostLabelLayout = (0,_label_labelLayoutHelper_js__rspack_import_3.newLabelLayoutWithGeometry)({
        marginForce: marginForce
      }, outmostLabelLayout);
      innerLabelLayout = (0,_label_labelLayoutHelper_js__rspack_import_3.newLabelLayoutWithGeometry)({
        marginForce: marginForce
      }, innerLabelLayout);
    }
    if ((0,_label_labelLayoutHelper_js__rspack_import_3.labelIntersect)(outmostLabelLayout, innerLabelLayout, null, {
...
function syncLabelIgnoreToMajorTicks(cfg, labelLayoutList, tickEls) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_2.each)(labelLayoutList, function (labelLayout) {
...
function createTicks(ticksCoords, tickTransform, tickEndCoord, tickLineStyle, anidPrefix) {
  ...
  for (var i = 0; i < ticksCoords.length; i++) {
    ...
    pt2[1] = tickEndCoord;
    if (tickTransform) {
      (0,zrender_lib_core_vector_js__rspack_import_9.applyTransform)(pt1, pt1, tickTransform);
      (0,zrender_lib_core_vector_js__rspack_import_9.applyTransform)(pt2, pt2, tickTransform);
    }
    // Tick line, Not use group transform to have better line draw
    var tickEl = new _util_graphic_js__rspack_import_11["default"]({
      shape: {
        x1: pt1[0],
        y1: pt1[1],
        x2: pt2[0],
    ...
    _util_graphic_js__rspack_import_12.subPixelOptimizeLine(tickEl.shape, tickEl.style.lineWidth);
...
function buildAxisMajorTicks(cfg, group, transformGroup, axisModel) {
  ...
  var ticksEls = createTicks(ticksCoords, transformGroup.transform, tickEndCoord, (0,zrender_lib_core_util_js__rspack_import_2.defaults)(lineStyleModel.getLineStyle(), {
...
function buildAxisMinorTicks(cfg, group, transformGroup, axisModel, tickDirection) {
  ...
  var minorTickLineStyle = (0,zrender_lib_core_util_js__rspack_import_2.defaults)(lineStyleModel.getLineStyle(), (0,zrender_lib_core_util_js__rspack_import_2.defaults)(axisModel.getModel('axisTick').getLineStyle(), {
    stroke: axisModel.get(['axisLine', 'lineStyle', 'color'])
  }));
...
function buildAxisLabel(cfg, local, group, kind, axisModel, api) {
  var axis = axisModel.axis;
  var show = (0,zrender_lib_core_util_js__rspack_import_2.retrieve)(cfg.raw.axisLabelShow, axisModel.get(['axisLabel', 'show']));
  var labelGroup = new _util_graphic_js__rspack_import_7["default"]();
  group.add(labelGroup);
  var axisLabelCreationCtx = (0,_coord_axisTickLabelBuilder_js__rspack_import_14.createAxisLabelsComputingContext)(kind);
  ...
  var labelRotation = ((0,zrender_lib_core_util_js__rspack_import_2.retrieve)(cfg.raw.labelRotate, labelModel.get('rotate')) || 0) * PI / 180;
  ...
  var z2Min = Infinity;
  var z2Max = -Infinity;
  (0,zrender_lib_core_util_js__rspack_import_2.each)(labels, function (labelItem, index) {
    var _a;
    ...
    if (rawCategoryData && rawCategoryData[tickValue]) {
      var rawCategoryItem = rawCategoryData[tickValue];
      if ((0,zrender_lib_core_util_js__rspack_import_2.isObject)(rawCategoryItem) && rawCategoryItem.textStyle) {
        itemLabelModel = new _model_Model_js__rspack_import_18["default"](rawCategoryItem.textStyle, labelModel, axisModel.ecModel);
      }
    }
    var textColor = itemLabelModel.getTextColor() || axisModel.get(['axisLine', 'lineStyle', 'color']);
    var align = itemLabelModel.getShallow('align', true) || labelLayout.textAlign;
    var alignMin = (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(itemLabelModel.getShallow('alignMinLabel', true), align);
    var alignMax = (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(itemLabelModel.getShallow('alignMaxLabel', true), align);
    var verticalAlign = itemLabelModel.getShallow('verticalAlign', true) || itemLabelModel.getShallow('baseline', true) || labelLayout.textVerticalAlign;
    var verticalAlignMin = (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(itemLabelModel.getShallow('verticalAlignMinLabel', true), verticalAlign);
    var verticalAlignMax = (0,zrender_lib_core_util_js__rspack_import_2.retrieve2)(itemLabelModel.getShallow('verticalAlignMaxLabel', true), verticalAlign);
    ...
    var textEl = new _util_graphic_js__rspack_import_15["default"]({
      ...
      silent: AxisBuilder.isLabelSilent(axisModel),
      z2: z2,
      style: (0,_label_labelStyle_js__rspack_import_16.createTextStyle)(itemLabelModel, {
        text: formattedLabel,
        align: index === 0 ? alignMin : index === labels.length - 1 ? alignMax : align,
        verticalAlign: index === 0 ? verticalAlignMin : index === labels.length - 1 ? verticalAlignMax : verticalAlign,
        fill: (0,zrender_lib_core_util_js__rspack_import_2.isFunction)(textColor) ? textColor(
  ...
  var labelLayoutList = (0,zrender_lib_core_util_js__rspack_import_2.map)(labelEls, function (label) {
    return {
      label: label,
...
function updateAxisLabelChangableProps(cfg, axisModel, labelLayoutList, transformGroup) {
  ...
  (0,zrender_lib_core_util_js__rspack_import_2.each)(labelLayoutList, function (layout, idx) {
    var geometry = (0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)(layout);
    if (!geometry) {
      return;
    }
    ...
    (0,zrender_lib_core_Transformable_js__rspack_import_19.copyTransform)(_tmpLayoutEl, _tmpLayoutElReset);
    ...
    (0,zrender_lib_core_Transformable_js__rspack_import_19.copyTransform)(labelEl, _tmpLayoutEl);
    labelEl.markRedraw();
    (0,_label_labelLayoutHelper_js__rspack_import_3.setLabelLayoutDirty)(geometry, true);
    (0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)(geometry);
  });
}
var _tmpLayoutEl = new _util_graphic_js__rspack_import_20["default"]();
var _tmpLayoutElReset = new _util_graphic_js__rspack_import_20["default"]();
...
function addBreakEventHandler(axisModel, api, textEl, visualBreak) {
  textEl.on('click', function (params) {
    var payload = {
      type: _axisAction_js__rspack_import_21.AXIS_BREAK_EXPAND_ACTION_TYPE,
      breaks: [{
...
function adjustBreakLabels(axisModel, axisRotation, labelLayoutList) {
  var scaleBreakHelper = (0,_scale_break_js__rspack_import_22.getScaleBreakHelper)();
  if (!scaleBreakHelper) {
    return;
  }
  ...
  if (moveOverlap === true || moveOverlap === 'auto') {
    (0,zrender_lib_core_util_js__rspack_import_2.each)(breakLabelIndexPairs, function (idxPair) {
      (0,_axisBreakHelper_js__rspack_import_10.getAxisBreakHelper)().adjustBreakLabelPair(axisModel.axis.inverse, axisRotation, [(0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)(labelLayoutList[idxPair[0]]), (0,_label_labelLayoutHelper_js__rspack_import_3.ensureLabelLayoutWithGeometry)(labelLayoutList[idxPair[1]])]);
    });
  }
}
/* export default */ __webpack_exports__["default"] = (AxisBuilder);

}),
40616: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var _axisPointer_modelHelper_js__rspack_import_2 = __webpack_require__(86442);
...
var AxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(AxisView, _super);
  function AxisView() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
  ...
  AxisView.prototype.render = function (axisModel, ecModel, api, payload) {
    ...
    this.axisPointerClass && _axisPointer_modelHelper_js__rspack_import_2.fixValue(axisModel);
  ...
  AxisView.prototype._doUpdateAxisPointerClass = function (axisModel, api, forceRender) {
    ...
    var axisPointerModel = _axisPointer_modelHelper_js__rspack_import_2.getAxisPointerModel(axisModel);
...
/* export default */ __webpack_exports__["default"] = (AxisView);

}),
84332: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _util_graphic_js__rspack_import_7 = __webpack_require__(38401);
/* import */ var _AxisView_js__rspack_import_0 = __webpack_require__(40616);
/* import */ var _axisSplitHelper_js__rspack_import_6 = __webpack_require__(72782);
/* import */ var _axisBreakHelper_js__rspack_import_8 = __webpack_require__(874);
/* import */ var _coord_axisHelper_js__rspack_import_3 = __webpack_require__(62159);
...
var CartesianAxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(CartesianAxisView, _super);
  ...
  CartesianAxisView.prototype.render = function (axisModel, ecModel, api, payload) {
    ...
    this._axisGroup = new _util_graphic_js__rspack_import_2["default"]();
    this.group.add(this._axisGroup);
    if (!(0,_coord_axisHelper_js__rspack_import_3.shouldAxisShow)(axisModel)) {
      return;
    }
    this._axisGroup.add(axisModel.axis.axisBuilder.group);
    zrender_lib_core_util_js__rspack_import_4.each(selfBuilderAttrs, function (name) {
    ...
    if (!isInitialSortFromBarRacing) {
      _util_graphic_js__rspack_import_5.groupTransition(oldAxisGroup, this._axisGroup, axisModel);
    }
    _super.prototype.render.call(this, axisModel, ecModel, api, payload);
  };
  CartesianAxisView.prototype.remove = function () {
    (0,_axisSplitHelper_js__rspack_import_6.rectCoordAxisHandleRemove)(this);
  };
...
var axisElementBuilders = {
  splitLine: function (axisView, axisGroup, axisModel, gridModel, api) {
    ...
    lineColors = zrender_lib_core_util_js__rspack_import_4.isArray(lineColors) ? lineColors : [lineColors];
    ...
    for (var i = 0; i < ticksCoords.length; i++) {
      ...
      var colorIndex = lineCount++ % lineColors.length;
      var line = new _util_graphic_js__rspack_import_7["default"]({
        ...
        style: zrender_lib_core_util_js__rspack_import_4.defaults({
          stroke: lineColors[colorIndex]
        }, lineStyle),
        silent: true
      });
      _util_graphic_js__rspack_import_5.subPixelOptimizeLine(line.shape, lineStyle.lineWidth);
      axisGroup.add(line);
    }
  },
  ...
  splitArea: function (axisView, axisGroup, axisModel, gridModel, api) {
    (0,_axisSplitHelper_js__rspack_import_6.rectCoordAxisBuildSplitArea)(axisView, axisGroup, axisModel, gridModel);
  },
  breakArea: function (axisView, axisGroup, axisModel, gridModel, api) {
    var axisBreakHelper = (0,_axisBreakHelper_js__rspack_import_8.getAxisBreakHelper)();
...
var CartesianXAxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(CartesianXAxisView, _super);
...
var CartesianYAxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(CartesianYAxisView, _super);
...
/* export default */ __webpack_exports__["default"] = (CartesianAxisView);

}),
11579: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var zrender_lib_core_util_js__rspack_import_3 = __webpack_require__(9774);
/* import */ var _AxisBuilder_js__rspack_import_5 = __webpack_require__(45430);
/* import */ var _helper_BrushController_js__rspack_import_2 = __webpack_require__(84283);
/* import */ var _helper_brushHelper_js__rspack_import_8 = __webpack_require__(44307);
/* import */ var _util_graphic_js__rspack_import_4 = __webpack_require__(97786);
/* import */ var _util_graphic_js__rspack_import_6 = __webpack_require__(9412);
/* import */ var _util_graphic_js__rspack_import_7 = __webpack_require__(7544);
/* import */ var _view_Component_js__rspack_import_0 = __webpack_require__(95421);
...
var ParallelAxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(ParallelAxisView, _super);
  ...
  ParallelAxisView.prototype.init = function (ecModel, api) {
    ...
    (this._brushController = new _helper_BrushController_js__rspack_import_2["default"](api.getZr())).on('brush', zrender_lib_core_util_js__rspack_import_3.bind(this._onBrush, this));
  };
  ParallelAxisView.prototype.render = function (axisModel, ecModel, api, payload) {
    ...
    this.group.removeAll();
    var oldAxisGroup = this._axisGroup;
    this._axisGroup = new _util_graphic_js__rspack_import_4["default"]();
    this.group.add(this._axisGroup);
    ...
    var builderOpt = zrender_lib_core_util_js__rspack_import_3.extend({
      strokeContainThreshold: areaWidth
    }, axisLayout);
    var axisBuilder = new _AxisBuilder_js__rspack_import_5["default"](axisModel, api, builderOpt);
    axisBuilder.build();
    this._axisGroup.add(axisBuilder.group);
    this._refreshBrushController(builderOpt, areaSelectStyle, axisModel, coordSysModel, areaWidth, api);
    _util_graphic_js__rspack_import_6.groupTransition(oldAxisGroup, this._axisGroup, axisModel);
  };
  // /**
  //  * @override
  //  */
  ...
  ParallelAxisView.prototype._refreshBrushController = function (builderOpt, areaSelectStyle, axisModel, coordSysModel, areaWidth, api) {
    ...
    var rect = _util_graphic_js__rspack_import_7["default"].create({
      x: extent[0],
      y: -areaWidth / 2,
      width: extentLen,
      height: areaWidth
    ...
    this._brushController.mount({
      ...
      panelId: 'pl',
      clipPath: _helper_brushHelper_js__rspack_import_8.makeRectPanelClipPath(rect),
      isTargetByCursor: _helper_brushHelper_js__rspack_import_8.makeRectIsTargetByCursor(rect, api, coordSysModel),
      getLinearBrushOtherExtent: _helper_brushHelper_js__rspack_import_8.makeLinearBrushOtherExtent(rect, 0)
    }]).enableBrush({
      brushType: 'lineX',
  ...
  ParallelAxisView.prototype._onBrush = function (eventParam) {
    ...
    var axis = axisModel.axis;
    var intervals = zrender_lib_core_util_js__rspack_import_3.map(coverInfoList, function (coverInfo) {
...
function getCoverInfoList(axisModel) {
  var axis = axisModel.axis;
  return zrender_lib_core_util_js__rspack_import_3.map(axisModel.activeIntervals, function (interval) {
    return {
      brushType: 'lineX',
      panelId: 'pl',
...
/* export default */ __webpack_exports__["default"] = (ParallelAxisView);

}),
88118: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var zrender_lib_core_util_js__rspack_import_5 = __webpack_require__(9774);
/* import */ var _util_graphic_js__rspack_import_2 = __webpack_require__(97786);
/* import */ var _util_graphic_js__rspack_import_4 = __webpack_require__(9412);
/* import */ var _util_graphic_js__rspack_import_6 = __webpack_require__(29471);
/* import */ var _util_graphic_js__rspack_import_7 = __webpack_require__(98528);
/* import */ var _AxisBuilder_js__rspack_import_3 = __webpack_require__(45430);
/* import */ var _AxisView_js__rspack_import_0 = __webpack_require__(40616);
...
var RadiusAxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(RadiusAxisView, _super);
  ...
  RadiusAxisView.prototype.render = function (radiusAxisModel, ecModel, api) {
    ...
    var oldAxisGroup = this._axisGroup;
    var newAxisGroup = this._axisGroup = new _util_graphic_js__rspack_import_2["default"]();
    ...
    var axisBuilder = new _AxisBuilder_js__rspack_import_3["default"](radiusAxisModel, api, layout);
    axisBuilder.build();
    newAxisGroup.add(axisBuilder.group);
    _util_graphic_js__rspack_import_4.groupTransition(oldAxisGroup, newAxisGroup, radiusAxisModel);
    zrender_lib_core_util_js__rspack_import_5.each(selfBuilderAttrs, function (name) {
...
var axisElementBuilders = {
  splitLine: function (group, radiusAxisModel, polar, axisAngle, radiusExtent, ticksCoords) {
    ...
    for (var i = 0; i < ticksCoords.length; i++) {
      var colorIndex = lineCount++ % lineColors.length;
      splitLines[colorIndex] = splitLines[colorIndex] || [];
      splitLines[colorIndex].push(new _util_graphic_js__rspack_import_4[shapeType]({
        shape: {
          cx: polar.cx,
          cy: polar.cy,
    ...
    // Batching the lines if color are the same
    for (var i = 0; i < splitLines.length; i++) {
      group.add(_util_graphic_js__rspack_import_4.mergePath(splitLines[i], {
        style: zrender_lib_core_util_js__rspack_import_5.defaults({
          stroke: lineColors[i % lineColors.length],
          fill: null
        }, lineStyleModel.getLineStyle()),
        silent: true
  ...
  minorSplitLine: function (group, radiusAxisModel, polar, axisAngle, radiusExtent, ticksCoords, minorTicksCoords) {
    ...
    for (var i = 0; i < minorTicksCoords.length; i++) {
      for (var k = 0; k < minorTicksCoords[i].length; k++) {
        lines.push(new _util_graphic_js__rspack_import_6["default"]({
          shape: {
            cx: polar.cx,
            cy: polar.cy,
    ...
    group.add(_util_graphic_js__rspack_import_4.mergePath(lines, {
      style: zrender_lib_core_util_js__rspack_import_5.defaults({
        fill: null
      }, lineStyleModel.getLineStyle()),
      silent: true
  ...
  splitArea: function (group, radiusAxisModel, polar, axisAngle, radiusExtent, ticksCoords) {
    ...
    for (var i = 1; i < ticksCoords.length; i++) {
      var colorIndex = lineCount++ % areaColors.length;
      splitAreas[colorIndex] = splitAreas[colorIndex] || [];
      splitAreas[colorIndex].push(new _util_graphic_js__rspack_import_7["default"]({
        shape: {
          cx: polar.cx,
          cy: polar.cy,
          r0: prevRadius,
    ...
    // Batching the lines if color are the same
    for (var i = 0; i < splitAreas.length; i++) {
      group.add(_util_graphic_js__rspack_import_4.mergePath(splitAreas[i], {
        style: zrender_lib_core_util_js__rspack_import_5.defaults({
          fill: areaColors[i % areaColors.length]
        }, areaStyleModel.getAreaStyle()),
        silent: true
...
/* export default */ __webpack_exports__["default"] = (RadiusAxisView);

}),
18704: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var zrender_lib_core_util_js__rspack_import_5 = __webpack_require__(9774);
/* import */ var _AxisBuilder_js__rspack_import_4 = __webpack_require__(45430);
/* import */ var _util_graphic_js__rspack_import_2 = __webpack_require__(97786);
/* import */ var _util_graphic_js__rspack_import_6 = __webpack_require__(9412);
/* import */ var _util_graphic_js__rspack_import_8 = __webpack_require__(38401);
/* import */ var _coord_single_singleAxisHelper_js__rspack_import_3 = __webpack_require__(62332);
/* import */ var _AxisView_js__rspack_import_0 = __webpack_require__(40616);
/* import */ var _axisSplitHelper_js__rspack_import_7 = __webpack_require__(72782);
/* import */ var _axisBreakHelper_js__rspack_import_9 = __webpack_require__(874);
...
var SingleAxisView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(SingleAxisView, _super);
  ...
  SingleAxisView.prototype.render = function (axisModel, ecModel, api, payload) {
    ...
    var oldAxisGroup = this._axisGroup;
    this._axisGroup = new _util_graphic_js__rspack_import_2["default"]();
    var layout = _coord_single_singleAxisHelper_js__rspack_import_3.layout(axisModel);
    var axisBuilder = new _AxisBuilder_js__rspack_import_4["default"](axisModel, api, layout);
    axisBuilder.build();
  ...
  SingleAxisView.prototype.remove = function () {
    (0,_axisSplitHelper_js__rspack_import_7.rectCoordAxisHandleRemove)(this);
  };
...
var axisElementBuilders = {
  splitLine: function (axisView, group, axisGroup, axisModel, api) {
    ...
    for (var i = 0; i < ticksCoords.length; ++i) {
      ...
      var line = new _util_graphic_js__rspack_import_8["default"]({
        shape: {
          x1: p1[0],
          y1: p1[1],
          x2: p2[0],
      ...
      _util_graphic_js__rspack_import_6.subPixelOptimizeLine(line.shape, lineWidth);
      var colorIndex = lineCount++ % lineColors.length;
      splitLines[colorIndex] = splitLines[colorIndex] || [];
    ...
    for (var i = 0; i < splitLines.length; ++i) {
      group.add(_util_graphic_js__rspack_import_6.mergePath(splitLines[i], {
        style: zrender_lib_core_util_js__rspack_import_5.defaults({
          stroke: lineColors[i % lineColors.length]
        }, lineStyle),
        silent: true
  ...
  splitArea: function (axisView, group, axisGroup, axisModel, api) {
    (0,_axisSplitHelper_js__rspack_import_7.rectCoordAxisBuildSplitArea)(axisView, axisGroup, axisModel, axisModel);
  },
  breakArea: function (axisView, group, axisGroup, axisModel, api) {
    var axisBreakHelper = (0,_axisBreakHelper_js__rspack_import_9.getAxisBreakHelper)();
    var scale = axisModel.axis.scale;
    if (axisBreakHelper && scale.type !== 'ordinal') {
...
/* export default */ __webpack_exports__["default"] = (SingleAxisView);

}),
11943: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function refineAxisBreakChangeEvent(actionResultBatch, payload, ecModel, api) {
  var breaks = [];
  (0,zrender_lib_core_util_js__rspack_import_0.each)(actionResultBatch, function (actionResult) {
...
function registerAction(registers) {
  ...
  function actionHandler(payload, ecModel) {
    var eventBreaks = [];
    var finderResult = (0,_util_model_js__rspack_import_1.parseFinder)(ecModel, payload);
    function dealUpdate(modelProp, indexProp) {
      (0,zrender_lib_core_util_js__rspack_import_0.each)(finderResult[modelProp], function (axisModel) {
        var result = axisModel.updateAxisBreaks(payload);
        (0,zrender_lib_core_util_js__rspack_import_0.each)(result.breaks, function (item) {
          var _a;
          eventBreaks.push((0,zrender_lib_core_util_js__rspack_import_0.defaults)((_a = {}, _a[indexProp] = axisModel.componentIndex, _a), item));
        });
      });
    }
...
874: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
72782: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function rectCoordAxisBuildSplitArea(axisView, axisGroup, axisModel, gridModel) {
  ...
  var newSplitAreaColors = zrender_lib_core_util_js__rspack_import_1.createHashMap();
  var colorIndex = 0;
  ...
  areaColors = zrender_lib_core_util_js__rspack_import_1.isArray(areaColors) ? areaColors : [areaColors];
  for (var i = 1; i < ticksCoords.length; i++) {
    var tickCoord = axis.toGlobalCoord(ticksCoords[i].coord);
    var x = void 0;
    var y = void 0;
    ...
    axisGroup.add(new _util_graphic_js__rspack_import_2["default"]({
      ...
      style: zrender_lib_core_util_js__rspack_import_1.defaults({
...
38424: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var scale_break = __webpack_require__(8188);
...
var axisBreakHelper = __webpack_require__(874);
...
59408: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
39698: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var zrender_lib_core_util_js__rspack_import_1 = __webpack_require__(9774);
/* import */ var _util_graphic_js__rspack_import_2 = __webpack_require__(97786);
/* import */ var _util_graphic_js__rspack_import_4 = __webpack_require__(9412);
/* import */ var _util_graphic_js__rspack_import_5 = __webpack_require__(62070);
/* import */ var _util_graphic_js__rspack_import_8 = __webpack_require__(95086);
/* import */ var _modelHelper_js__rspack_import_3 = __webpack_require__(86442);
/* import */ var zrender_lib_core_event_js__rspack_import_6 = __webpack_require__(31720);
/* import */ var _util_throttle_js__rspack_import_7 = __webpack_require__(19007);
/* import */ var _util_model_js__rspack_import_0 = __webpack_require__(67698);
...
var inner = (0,_util_model_js__rspack_import_0.makeInner)();
var clone = zrender_lib_core_util_js__rspack_import_1.clone;
var bind = zrender_lib_core_util_js__rspack_import_1.bind;
/**
...
var BaseAxisPointer = /** @class */function () {
  ...
  BaseAxisPointer.prototype.render = function (axisModel, axisPointerModel, api, forceRender) {
    ...
    if (!group) {
      group = this._group = new _util_graphic_js__rspack_import_2["default"]();
      this.createPointerEl(group, elOption, axisModel, axisPointerModel);
      this.createLabelEl(group, elOption, axisModel, axisPointerModel);
      api.getZr().add(group);
    } else {
      var doUpdateProps = zrender_lib_core_util_js__rspack_import_1.curry(updateProps, axisPointerModel, moveAnimation);
  ...
  BaseAxisPointer.prototype.determineAnimation = function (axisModel, axisPointerModel) {
    ...
    if (animation === 'auto' || animation == null) {
      ...
      if (useSnap) {
        var seriesDataCount = _modelHelper_js__rspack_import_3.getAxisInfo(axisModel).seriesDataCount;
  ...
  BaseAxisPointer.prototype.createPointerEl = function (group, elOption, axisModel, axisPointerModel) {
    ...
    if (pointerOption) {
      var pointerEl = inner(group).pointerEl = new _util_graphic_js__rspack_import_4[pointerOption.type](clone(elOption.pointer));
      group.add(pointerEl);
    }
  };
  /**
  ...
  BaseAxisPointer.prototype.createLabelEl = function (group, elOption, axisModel, axisPointerModel) {
    if (elOption.label) {
      var labelEl = inner(group).labelEl = new _util_graphic_js__rspack_import_5["default"](clone(elOption.label));
      group.add(labelEl);
  ...
  BaseAxisPointer.prototype._renderHandle = function (value) {
    ...
    if (!this._handle) {
      isInit = true;
      handle = this._handle = _util_graphic_js__rspack_import_4.createIcon(handleModel.get('icon'), {
        cursor: 'move',
        draggable: true,
        onmousemove: function (e) {
          // For mobile device, prevent screen slider on the button.
          zrender_lib_core_event_js__rspack_import_6.stop(e.event);
        },
    ...
    if (!zrender_lib_core_util_js__rspack_import_1.isArray(handleSize)) {
      handleSize = [handleSize, handleSize];
    }
    handle.scaleX = handleSize[0] / 2;
    handle.scaleY = handleSize[1] / 2;
    _util_throttle_js__rspack_import_7.createOrUpdate(this, '_doDispatchAxisPointer', handleModel.get('throttle') || 0, 'fixRate');
  ...
  BaseAxisPointer.prototype.clear = function (api) {
    ...
    _util_throttle_js__rspack_import_7.clear(this, '_doDispatchAxisPointer');
  };
  /**
   * @protected
   */
...
function updateProps(animationModel, moveAnimation, el, props) {
  ...
  if (!propsEqual(inner(el).lastProp, props)) {
    ...
    moveAnimation ? _util_graphic_js__rspack_import_8.updateProps(el, props, animationModel) : (el.stopAnimation(), el.attr(props));
  }
}
function propsEqual(lastProps, newProps) {
  if (zrender_lib_core_util_js__rspack_import_1.isObject(lastProps) && zrender_lib_core_util_js__rspack_import_1.isObject(newProps)) {
    var equals_1 = true;
    zrender_lib_core_util_js__rspack_import_1.each(newProps, function (item, key) {
...
/* export default */ __webpack_exports__["default"] = (BaseAxisPointer);

}),
12617: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var _BaseAxisPointer_js__rspack_import_0 = __webpack_require__(39698);
/* import */ var _util_graphic_js__rspack_import_4 = __webpack_require__(9412);
/* import */ var _viewHelper_js__rspack_import_2 = __webpack_require__(74430);
/* import */ var zrender_lib_core_matrix_js__rspack_import_3 = __webpack_require__(46239);
/* import */ var _axis_AxisBuilder_js__rspack_import_5 = __webpack_require__(45430);
...
var PolarAxisPointer = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(PolarAxisPointer, _super);
  ...
  PolarAxisPointer.prototype.makeElOption = function (elOption, value, axisModel, axisPointerModel, api) {
    ...
    if (axisPointerType && axisPointerType !== 'none') {
      var elStyle = _viewHelper_js__rspack_import_2.buildElStyle(axisPointerModel);
    ...
    _viewHelper_js__rspack_import_2.buildLabelElOption(elOption, axisModel, axisPointerModel, api, labelPos);
  };
  return PolarAxisPointer;
}(_BaseAxisPointer_js__rspack_import_0["default"]);
;
function getLabelPosition(value, axisModel, axisPointerModel, polar, labelMargin) {
  ...
  var verticalAlign;
  if (axis.dim === 'radius') {
    var transform = zrender_lib_core_matrix_js__rspack_import_3.create();
    zrender_lib_core_matrix_js__rspack_import_3.rotate(transform, transform, axisAngle);
    zrender_lib_core_matrix_js__rspack_import_3.translate(transform, transform, [polar.cx, polar.cy]);
    position = _util_graphic_js__rspack_import_4.applyTransform([coord, -labelMargin], transform);
    var labelRotation = axisModel.getModel('axisLabel').get('rotate') || 0;
    // @ts-ignore
    var labelLayout = _axis_AxisBuilder_js__rspack_import_5["default"].innerTextLayout(axisAngle, labelRotation * Math.PI / 180, -1);
...
var pointerShapeBuilder = {
  line: function (axis, polar, coordValue, otherExtent) {
    return axis.dim === 'angle' ? {
      type: 'Line',
      shape: _viewHelper_js__rspack_import_2.makeLineShape(polar.coordToPoint([otherExtent[0], coordValue]), polar.coordToPoint([otherExtent[1], coordValue]))
    } : {
      type: 'Circle',
      shape: {
        cx: polar.cx,
  ...
  shadow: function (axis, polar, coordValue, otherExtent) {
    ...
    return axis.dim === 'angle' ? {
      type: 'Sector',
      shape: _viewHelper_js__rspack_import_2.makeSectorShape(polar.cx, polar.cy, otherExtent[0], otherExtent[1],
      // In ECharts y is negative if angle is positive
      (-coordValue - bandWidth / 2) * radian, (-coordValue + bandWidth / 2) * radian)
    } : {
      type: 'Sector',
      shape: _viewHelper_js__rspack_import_2.makeSectorShape(polar.cx, polar.cy, coordValue - bandWidth / 2, coordValue + bandWidth / 2, 0, Math.PI * 2)
    };
  }
};
/* export default */ __webpack_exports__["default"] = (PolarAxisPointer);

}),
74825: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var _BaseAxisPointer_js__rspack_import_0 = __webpack_require__(39698);
/* import */ var _viewHelper_js__rspack_import_2 = __webpack_require__(74430);
...
var SingleAxisPointer = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(SingleAxisPointer, _super);
  ...
  SingleAxisPointer.prototype.makeElOption = function (elOption, value, axisModel, axisPointerModel, api) {
    ...
    var layoutInfo = _coord_single_singleAxisHelper_js__rspack_import_3.layout(axisModel);
    _viewHelper_js__rspack_import_2.buildCartesianSingleLabelElOption(value, elOption, layoutInfo, axisModel, axisPointerModel, api);
  };
  /**
   * @override
   */
  SingleAxisPointer.prototype.getHandleTransform = function (value, axisModel, axisPointerModel) {
    ...
    var position = _viewHelper_js__rspack_import_2.getTransformedPosition(axisModel.axis, value, layoutInfo);
    return {
      x: position[0],
      y: position[1],
...
var pointerShapeBuilder = {
  line: function (axis, pixelValue, otherExtent) {
    var targetShape = _viewHelper_js__rspack_import_2.makeLineShape([pixelValue, otherExtent[0]], [pixelValue, otherExtent[1]], getPointDimIndex(axis));
    return {
      type: 'Line',
  ...
  shadow: function (axis, pixelValue, otherExtent) {
    ...
    return {
      type: 'Rect',
      shape: _viewHelper_js__rspack_import_2.makeRectShape([pixelValue - bandWidth / 2, otherExtent[0]], [bandWidth, span], getPointDimIndex(axis))
    };
  }
};
...
/* export default */ __webpack_exports__["default"] = (SingleAxisPointer);

}),
66613: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function findPointFromSeries(finder, ecModel) {
  ...
  var dataIndex = _util_model_js__rspack_import_0.queryDataIndex(data, finder);
  if (dataIndex == null || dataIndex < 0 || zrender_lib_core_util_js__rspack_import_1.isArray(dataIndex)) {
    return {
      point: []
    };
  }
  ...
  if (seriesModel.getTooltipPosition) {
    ...
    if (finder.isStacked) {
      ...
      point = coordSys.dataToPoint(data.getValues(zrender_lib_core_util_js__rspack_import_1.map(coordSys.dimensions, function (dim) {
...
44632: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
var inner = (0,_util_model_js__rspack_import_0.makeInner)();
var each = zrender_lib_core_util_js__rspack_import_1.each;
/**
 * @param {string} key
...
function register(key, api, handler) {
  if (zrender_lib_core_env_js__rspack_import_2["default"].node) {
    return;
  }
  var zr = api.getZr();
...
function initGlobalListeners(zr, api) {
  ...
  useHandler('click', zrender_lib_core_util_js__rspack_import_1.curry(doEnter, 'click'));
  useHandler('mousemove', zrender_lib_core_util_js__rspack_import_1.curry(doEnter, 'mousemove'));
...
76679: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var AxisView = __webpack_require__(40616);
...
/* export default */ var axisPointer_CartesianAxisPointer = (CartesianAxisPointer_CartesianAxisPointer);
...
/* export default */ var axisPointer_AxisPointerModel = (AxisPointerModel_AxisPointerModel);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/component/axisPointer/globalListener.js
var globalListener = __webpack_require__(44632);
...
/* export default */ var axisPointer_AxisPointerView = (AxisPointerView_AxisPointerView);
// EXTERNAL MODULE: ./node_modules/.pnpm/zrender@6.0.0/node_modules/zrender/lib/core/util.js
var util = __webpack_require__(9774);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/component/axisPointer/modelHelper.js
var modelHelper = __webpack_require__(86442);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/util/model.js
...
var findPointFromSeries = __webpack_require__(66613);
...
86442: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function collectAxesInfo(result, ecModel, api) {
  ...
  var linkGroups = [];
  // Collect axes info.
  (0,zrender_lib_core_util_js__rspack_import_0.each)(api.getCoordinateSystems(), function (coordSys) {
    ...
    (0,zrender_lib_core_util_js__rspack_import_0.each)(coordSys.getAxes(), (0,zrender_lib_core_util_js__rspack_import_0.curry)(saveTooltipAxisInfo, false, null));
    ...
    && baseTooltipModel.get('show')) {
      ...
      if (triggerAxis || cross) {
        (0,zrender_lib_core_util_js__rspack_import_0.each)(tooltipAxes.baseAxes, (0,zrender_lib_core_util_js__rspack_import_0.curry)(saveTooltipAxisInfo, cross ? 'cross' : true, triggerAxis));
      }
      if (cross) {
        (0,zrender_lib_core_util_js__rspack_import_0.each)(tooltipAxes.otherAxes, (0,zrender_lib_core_util_js__rspack_import_0.curry)(saveTooltipAxisInfo, 'cross', false));
      }
    }
...
function makeAxisPointerModel(axis, baseTooltipModel, globalAxisPointerModel, ecModel, fromTooltip, triggerTooltip) {
  ...
  var volatileOption = {};
  (0,zrender_lib_core_util_js__rspack_import_0.each)(fields, function (field) {
    volatileOption[field] = (0,zrender_lib_core_util_js__rspack_import_0.clone)(tooltipAxisPointerModel.get(field));
  });
  ...
  if (fromTooltip === 'cross') {
    ...
    if (!triggerTooltip) {
      ...
      crossStyle && (0,zrender_lib_core_util_js__rspack_import_0.defaults)(labelOption, crossStyle.textStyle);
    }
  }
  return axis.model.getModel('axisPointer', new _model_Model_js__rspack_import_1["default"](volatileOption, globalAxisPointerModel, ecModel));
}
function collectSeriesInfo(result, ecModel) {
  ...
  ecModel.eachSeries(function (seriesModel) {
    ...
    (0,zrender_lib_core_util_js__rspack_import_0.each)(result.coordSysAxesInfo[makeKey(coordSys.model)], function (axisInfo) {
      var axis = axisInfo.axis;
...
function checkPropInLink(linkPropValue, axisPropValue) {
  return linkPropValue === 'all' || (0,zrender_lib_core_util_js__rspack_import_0.isArray)(linkPropValue) && (0,zrender_lib_core_util_js__rspack_import_0.indexOf)(linkPropValue, axisPropValue) >= 0 || linkPropValue === axisPropValue;
}
...
74430: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _coord_axisHelper_js__rspack_import_3 = __webpack_require__(62159);
/* import */ var _axis_AxisBuilder_js__rspack_import_7 = __webpack_require__(45430);
/* import */ var _label_labelStyle_js__rspack_import_2 = __webpack_require__(51160);
...
function buildLabelElOption(elOption, axisModel, axisPointerModel, api, labelPos) {
  ...
  var paddings = _util_format_js__rspack_import_0.normalizeCssArray(labelModel.get('padding') || 0);
  var font = labelModel.getFont();
  var textRect = zrender_lib_contain_text_js__rspack_import_1.getBoundingRect(text, font);
  ...
  elOption.label = {
    ...
    x: position[0],
    y: position[1],
    style: (0,_label_labelStyle_js__rspack_import_2.createTextStyle)(labelModel, {
      text: text,
      font: font,
...
function getValueLabel(value, axis, ecModel, seriesDataIndices, opt) {
  ...
  if (formatter) {
    var params_1 = {
      value: _coord_axisHelper_js__rspack_import_3.getAxisRawValue(axis, {
        value: value
      }),
    ...
    zrender_lib_core_util_js__rspack_import_4.each(seriesDataIndices, function (idxItem) {
      var series = ecModel.getSeriesByIndex(idxItem.seriesIndex);
      var dataIndex = idxItem.dataIndexInside;
      var dataParams = series && series.getDataParams(dataIndex);
      dataParams && params_1.seriesData.push(dataParams);
    });
    if (zrender_lib_core_util_js__rspack_import_4.isString(formatter)) {
      text = formatter.replace('{value}', text);
    } else if (zrender_lib_core_util_js__rspack_import_4.isFunction(formatter)) {
...
function getTransformedPosition(axis, value, layoutInfo) {
  var transform = zrender_lib_core_matrix_js__rspack_import_5.create();
  zrender_lib_core_matrix_js__rspack_import_5.rotate(transform, transform, layoutInfo.rotation);
  zrender_lib_core_matrix_js__rspack_import_5.translate(transform, transform, layoutInfo.position);
  return _util_graphic_js__rspack_import_6.applyTransform([axis.dataToCoord(value), (layoutInfo.labelOffset || 0) + (layoutInfo.labelDirection || 1) * (layoutInfo.labelMargin || 0)], transform);
}
function buildCartesianSingleLabelElOption(value, elOption, layoutInfo, axisModel, axisPointerModel, api) {
  var textLayout = _axis_AxisBuilder_js__rspack_import_7["default"].innerTextLayout(layoutInfo.rotation, 0, layoutInfo.labelDirection);
...
4158: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var BrushController = __webpack_require__(84283);
...
/* export default */ var brush_selector = (selector);
...
var BrushTargetManager = __webpack_require__(33979);
...
/* export default */ var brush_BrushView = (BrushView_BrushView);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/model/Component.js
var model_Component = __webpack_require__(53075);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/visual/tokens.js
var tokens = __webpack_require__(87473);
...
65190: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var CalendarModel = __webpack_require__(82180);
// EXTERNAL MODULE: ./node_modules/.pnpm/tslib@2.3.0/node_modules/tslib/tslib.es6.js
var tslib_es6 = __webpack_require__(2492);
// EXTERNAL MODULE: ./node_modules/.pnpm/zrender@6.0.0/node_modules/zrender/lib/core/util.js
var util = __webpack_require__(9774);
...
var format = __webpack_require__(10236);
...
/* export default */ var calendar_CalendarView = (CalendarView_CalendarView);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/coord/calendar/Calendar.js
var Calendar = __webpack_require__(23181);
...
75700: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var zrender_lib_core_util_js__rspack_import_2 = __webpack_require__(9774);
/* import */ var _model_Component_js__rspack_import_0 = __webpack_require__(53075);
/* import */ var _helper_js__rspack_import_3 = __webpack_require__(30678);
...
var DataZoomModel = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(DataZoomModel, _super);
  ...
  DataZoomModel.prototype.mergeOption = function (newOption) {
    ...
    // FIX #2591
    (0,zrender_lib_core_util_js__rspack_import_2.merge)(this.option, newOption, true);
    (0,zrender_lib_core_util_js__rspack_import_2.merge)(this.settledOption, inputRawOption, true);
    this._doInit(inputRawOption);
  };
  DataZoomModel.prototype._doInit = function (inputRawOption) {
    ...
    (0,zrender_lib_core_util_js__rspack_import_2.each)([['start', 'startValue'], ['end', 'endValue']], function (names, index) {
  ...
  DataZoomModel.prototype._resetTarget = function () {
    ...
    var targetAxisIndexMap = this._targetAxisInfoMap = (0,zrender_lib_core_util_js__rspack_import_2.createHashMap)();
  ...
  DataZoomModel.prototype._fillSpecifiedTargetAxis = function (targetAxisIndexMap) {
    ...
    (0,zrender_lib_core_util_js__rspack_import_2.each)(_helper_js__rspack_import_3.DATA_ZOOM_AXIS_DIMENSIONS, function (axisDim) {
      var refering = this.getReferringComponents((0,_helper_js__rspack_import_3.getAxisMainType)(axisDim), _util_model_js__rspack_import_4.MULTIPLE_REFERRING);
      ...
      (0,zrender_lib_core_util_js__rspack_import_2.each)(refering.models, function (axisModel) {
  ...
  DataZoomModel.prototype._fillAutoTargetAxisByOrient = function (targetAxisIndexMap, orient) {
    ...
    function setParallelAxis(axisModels, axisDim) {
      ...
      if (axisDim === 'x' || axisDim === 'y') {
        var gridModel_1 = axisModel.getReferringComponents('grid', _util_model_js__rspack_import_4.SINGLE_REFERRING).models[0];
        gridModel_1 && (0,zrender_lib_core_util_js__rspack_import_2.each)(axisModels, function (axModel) {
          if (axisModel.componentIndex !== axModel.componentIndex && gridModel_1 === axModel.getReferringComponents('grid', _util_model_js__rspack_import_4.SINGLE_REFERRING).models[0]) {
    ...
    if (needAuto) {
      ...
      (0,zrender_lib_core_util_js__rspack_import_2.each)(_helper_js__rspack_import_3.DATA_ZOOM_AXIS_DIMENSIONS, function (axisDim) {
        ...
        var axisModels = ecModel.findComponents({
          mainType: (0,_helper_js__rspack_import_3.getAxisMainType)(axisDim),
          filter: function (axisModel) {
  ...
  DataZoomModel.prototype.getFirstTargetAxisModel = function () {
    ...
    this.eachTargetAxis(function (axisDim, axisIndex) {
      if (firstAxisModel == null) {
        firstAxisModel = this.ecModel.getComponent((0,_helper_js__rspack_import_3.getAxisMainType)(axisDim), axisIndex);
      }
    }, this);
  ...
  DataZoomModel.prototype.eachTargetAxis = function (callback, context) {
    this._targetAxisInfoMap.each(function (axisInfo, axisDim) {
      (0,zrender_lib_core_util_js__rspack_import_2.each)(axisInfo.indexList, function (axisIndex) {
  ...
  DataZoomModel.prototype.getAxisModel = function (axisDim, axisIndex) {
    ...
    if (axisInfo && axisInfo.indexMap[axisIndex]) {
      return this.ecModel.getComponent((0,_helper_js__rspack_import_3.getAxisMainType)(axisDim), axisIndex);
    }
  };
  /**
  ...
  DataZoomModel.prototype.setRawRange = function (opt) {
    var thisOption = this.option;
    var settledOption = this.settledOption;
    (0,zrender_lib_core_util_js__rspack_import_2.each)([['start', 'startValue'], ['end', 'endValue']], function (names) {
  ...
  DataZoomModel.prototype.setCalculatedRange = function (opt) {
    ...
    (0,zrender_lib_core_util_js__rspack_import_2.each)(['start', 'startValue', 'end', 'endValue'], function (name) {
...
function retrieveRawOption(option) {
  var ret = {};
  (0,zrender_lib_core_util_js__rspack_import_2.each)(['start', 'end', 'startValue', 'endValue', 'throttle'], function (name) {
    option.hasOwnProperty(name) && (ret[name] = option[name]);
  });
  return ret;
}
/* export default */ __webpack_exports__["default"] = (DataZoomModel);

}),
37184: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var _view_Component_js__rspack_import_0 = __webpack_require__(95421);
...
var DataZoomView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(DataZoomView, _super);
...
/* export default */ __webpack_exports__["default"] = (DataZoomView);

}),
30678: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function isCoordSupported(seriesModel) {
  ...
  return (0,zrender_lib_core_util_js__rspack_import_0.indexOf)(SERIES_COORDS, coordType) >= 0;
}
...
function findEffectedDataZooms(ecModel, payload) {
  ...
  var axisRecords = (0,zrender_lib_core_util_js__rspack_import_0.createHashMap)();
  var effectedModels = [];
  // Key: uid of dataZoomModel
  var effectedModelMap = (0,zrender_lib_core_util_js__rspack_import_0.createHashMap)();
...
function collectReferCoordSysModelInfo(dataZoomModel) {
  ...
  var coordSysInfoWrap = {
    infoList: [],
    infoMap: (0,zrender_lib_core_util_js__rspack_import_0.createHashMap)()
  };
  dataZoomModel.eachTargetAxis(function (axisDim, axisIndex) {
...
12612: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
var inner = (0,_util_model_js__rspack_import_1.makeInner)();
/**
 * @param ecModel
...
71143: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  install: function() { return install; }
});
/* import */ var _extension_js__rspack_import_0 = __webpack_require__(51799);
/* import */ var _installDataZoomInside_js__rspack_import_1 = __webpack_require__(98020);
/* import */ var _installDataZoomSlider_js__rspack_import_2 = __webpack_require__(82520);
...
function install(registers) {
  (0,_extension_js__rspack_import_0.use)(_installDataZoomInside_js__rspack_import_1.install);
  (0,_extension_js__rspack_import_0.use)(_installDataZoomSlider_js__rspack_import_2.install);
  // Do not install './dataZoomSelect',
  // since it only work for toolbox dataZoom.
}

}),
31519: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var helper = __webpack_require__(30678);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/util/number.js
var number = __webpack_require__(64782);
...
var scaleRawExtentInfo = __webpack_require__(77646);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/util/model.js
var model = __webpack_require__(67698);
...
/* export default */ var dataZoom_AxisProxy = (AxisProxy_AxisProxy);
...
/* export default */ var dataZoom_dataZoomProcessor = (dataZoomProcessor);
...
98020: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var DataZoomModel = __webpack_require__(75700);
...
8022: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
/* export default */ var SelectZoomModel = (SelectZoomModel_SelectDataZoomModel);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/component/dataZoom/DataZoomView.js
var DataZoomView = __webpack_require__(37184);
...
/* export default */ var SelectZoomView = (SelectZoomView_SelectDataZoomView);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/component/dataZoom/installCommon.js + 3 modules
var installCommon = __webpack_require__(31519);
...
82520: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
/* export default */ var dataZoom_SliderZoomModel = (SliderZoomModel_SliderZoomModel);
// EXTERNAL MODULE: ./node_modules/.pnpm/zrender@6.0.0/node_modules/zrender/lib/core/util.js
var util = __webpack_require__(9774);
...
/* export default */ var dataZoom_SliderZoomView = (SliderZoomView_SliderZoomView);
// EXTERNAL MODULE: ./node_modules/.pnpm/echarts@6.0.0/node_modules/echarts/lib/component/dataZoom/installCommon.js + 3 modules
var installCommon = __webpack_require__(31519);
...
70742: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var tslib__rspack_import_1 = __webpack_require__(2492);
/* import */ var _model_Component_js__rspack_import_0 = __webpack_require__(53075);
/* import */ var _view_Component_js__rspack_import_4 = __webpack_require__(95421);
/* import */ var _util_types_js__rspack_import_3 = __webpack_require__(79390);
/* import */ var _data_helper_sourceManager_js__rspack_import_2 = __webpack_require__(88404);
...
var DatasetModel = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(DatasetModel, _super);
  ...
  DatasetModel.prototype.init = function (option, parentModel, ecModel) {
    ...
    this._sourceManager = new _data_helper_sourceManager_js__rspack_import_2.SourceManager(this);
    (0,_data_helper_sourceManager_js__rspack_import_2.disableTransformOptionMerge)(this);
  };
  ...
  DatasetModel.defaultOption = {
    seriesLayoutBy: _util_types_js__rspack_import_3.SERIES_LAYOUT_BY_COLUMN
  };
  return DatasetModel;
}(_model_Component_js__rspack_import_0["default"]);

var DatasetView = /** @class */function (_super) {
  (0,tslib__rspack_import_1.__extends)(DatasetView, _super);
  ...
  return DatasetView;
}(_view_Component_js__rspack_import_4["default"]);
function install(registers) {
...
59112: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
/* export default */ var geo_GeoView = (GeoView_GeoView);
